...
class MockACMSDocketReport:
    ...
    def _parse_text(self, json):
        acms_data = DocketDataFactory(
            ...
            docket_entries=[
                DocketEntryDataFactory(
                    date_filed=datetime(2023, 10, 2, 0, 0, 0),
                ...
                DocketEntryDataFactory(
                    date_filed=datetime(2023, 10, 3, 0, 0, 0),
                    date_entered=datetime(2023, 10, 3, 11, 21, 0),
                ...
                DocketEntryDataFactory(
                    date_filed=datetime(2023, 10, 1, 0, 0, 0),
                    date_entered=datetime(2023, 10, 1, 0, 0, 0),
                    description="<p><strong>MOTION</strong> [Entered: 10/01/2023 11:17 AM]</p>",
                ...
                DocketEntryDataFactory(
                    date_filed=datetime(2023, 10, 2, 0, 0, 0),
                    date_entered=datetime(2023, 10, 2, 0, 0, 0),
                    description="<p><strong>MOTION</strong> [Entered: 10/02/2023 11:17 AM]</p>",
                    pacer_doc_id="c5f76179-dd92-ee11-8179-001dd804e087",
                    document_number=None,
                    page_count=0,
                ),
                DocketEntryDataFactory(
                    date_filed=datetime(2023, 10, 4, 0, 0, 0),
                    date_entered=datetime(2023, 10, 4, 0, 0, 0),
                    description="<p><strong>MOTION</strong> [Entered: 10/04/2023 11:17 AM]</p>",
