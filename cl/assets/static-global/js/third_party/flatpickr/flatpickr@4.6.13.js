  ...
  function FlatpickrInstance(element, instanceConfig) {
    ...
    function buildTime() {
      ...
      if (!self.config.time_24hr) {
        ...
        self.amPM = createElement(
          'span',
          'flatpickr-am-pm',
          self.l10n.amPM[int((self.latestSelectedDateObj ? self.hourElement.value : self.config.defaultHour) > 11)]
        );
    ...
    function isEnabled(date, timeless) {
      ...
      if (
        (self.config.minDate &&
          dateToCheck &&
          compareDates(dateToCheck, self.config.minDate, timeless !== undefined ? timeless : !self.minDateHasTime) <
            0) ||
        (self.config.maxDate &&
          dateToCheck &&
    ...
    function positionCalendar(customPositionElement) {
      ...
      var calendarHeight = Array.prototype.reduce.call(
        ...
        showOnTop =
          ...
          (configPosVertical !== 'below' && distanceFromBottom < calendarHeight && inputBounds.top > calendarHeight);
      var top =
        window.pageYOffset + inputBounds.top + (!showOnTop ? positionElement.offsetHeight + 2 : -calendarHeight - 2);
