    ...
    operations = [
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    func='INSERT INTO "favorites_dockettagevent" ("docket_id", "id", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "tag_id") VALUES (OLD."docket_id", OLD."id", _pgh_attach_context(), NOW(), \'update_or_delete_snapshot\', OLD."id", OLD."tag_id"); RETURN NULL;',
                    hash="8f1df53f9cd8f17eb461118f6b48459fbf9db58e",
                    operation="UPDATE",
                    pgid="pgtrigger_update_or_delete_snapshot_update_88501",
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func='INSERT INTO "favorites_dockettagevent" ("docket_id", "id", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "tag_id") VALUES (OLD."docket_id", OLD."id", _pgh_attach_context(), NOW(), \'update_or_delete_snapshot\', OLD."id", OLD."tag_id"); RETURN NULL;',
                    hash="be481286dac59ff8609039001c4d5c0079f533c7",
                    operation="DELETE",
                    pgid="pgtrigger_update_or_delete_snapshot_delete_1a570",
                    table="favorites_dockettag",
                    when="AFTER",
                ),
            ),
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    hash="fcd6d536ae66f06cea145de113f778913b839c34",
                    operation="UPDATE",
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func='INSERT INTO "favorites_noteevent" ("audio_id_id", "cluster_id_id", "date_created", "date_modified", "docket_id_id", "id", "name", "notes", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "recap_doc_id_id", "user_id") VALUES (OLD."audio_id_id", OLD."cluster_id_id", OLD."date_created", OLD."date_modified", OLD."docket_id_id", OLD."id", OLD."name", OLD."notes", _pgh_attach_context(), NOW(), \'update_or_delete_snapshot\', OLD."id", OLD."recap_doc_id_id", OLD."user_id"); RETURN NULL;',
                    hash="4c1d04b7683ae122c2497aeee499ec9ac1025f4a",
                    operation="DELETE",
                    pgid="pgtrigger_update_or_delete_snapshot_delete_b6726",
                    table="favorites_note",
                    when="AFTER",
                ),
            ),
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    func='INSERT INTO "favorites_prayerevent" ("date_created", "id", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "recap_document_id", "user_id") VALUES (OLD."date_created", OLD."id", _pgh_attach_context(), NOW(), \'update_or_delete_snapshot\', OLD."id", OLD."recap_document_id", OLD."user_id"); RETURN NULL;',
                    hash="e42a6a5598ddff89e57948b099881f01be7d1ae6",
                    operation="UPDATE",
                    pgid="pgtrigger_update_or_delete_snapshot_update_67cd0",
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func='INSERT INTO "favorites_prayerevent" ("date_created", "id", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "recap_document_id", "user_id") VALUES (OLD."date_created", OLD."id", _pgh_attach_context(), NOW(), \'update_or_delete_snapshot\', OLD."id", OLD."recap_document_id", OLD."user_id"); RETURN NULL;',
                    hash="bcc156e7d8aa54c45556d82c5a88792d6be2dc9e",
                    operation="DELETE",
                    pgid="pgtrigger_update_or_delete_snapshot_delete_89611",
                    table="favorites_prayer",
                    when="AFTER",
                ),
            ),
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    hash="1f0b6589dbf1673b54b022f55026d469b7497e06",
                    operation="UPDATE",
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func='INSERT INTO "favorites_usertagevent" ("date_created", "date_modified", "description", "id", "name", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "published", "title", "user_id") VALUES (OLD."date_created", OLD."date_modified", OLD."description", OLD."id", OLD."name", _pgh_attach_context(), NOW(), \'update_or_delete_snapshot\', OLD."id", OLD."published", OLD."title", OLD."user_id"); RETURN NULL;',
                    hash="ae91cd3be4454f2f23f7e656d244f63d8d79ff18",
                    operation="DELETE",
                    pgid="pgtrigger_update_or_delete_snapshot_delete_e4ac4",
                    table="favorites_usertag",
                    when="AFTER",
                ),
            ),
