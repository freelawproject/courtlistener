    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_provider', models.CharField(max_length=50, choices=[('dwolla', 'Dwolla'), ('paypal', 'PayPal'), ('cc', 'Credit Card'), ('check', 'Check'), ('bitcoin', 'Bitcoin')])),
                ...
                ('donor', models.ForeignKey(related_name='monthly_donations', to=settings.AUTH_USER_MODEL, help_text='The user that made the donation',
        ...
        migrations.AlterField(
            model_name='donation',
            name='payment_id',
            field=models.CharField(help_text='Internal ID used during a transaction (used by PayPal and Stripe).', max_length=64),
        ),
        migrations.AlterField(
            model_name='donation',
            name='transaction_id',
            field=models.CharField(help_text='The ID of a transaction made in PayPal.', max_length=64, null=True, blank=True),
        ),
    ]
