    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_entered', models.DateTimeField(help_text=b'The datetime when the note was entered', verbose_name=b'Note Creation Date')),
                ('notes', models.TextField(help_text=b'Any notes you wish to keep about this item')),
