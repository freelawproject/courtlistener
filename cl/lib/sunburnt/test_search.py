...
schema_string = """<schema name="timetric" version="1.1">
...
good_query_data = {
    "query_by_term": (
        (["hello"], {}, [("q", u"hello")]),
        (["hello"], {"int_field": 3}, [("q", u"hello AND int_field:3")]),
        (["hello", "world"], {}, [("q", u"hello AND world")]),
        # NB this next is not really what we want,
        # probably this should warn
        (["hello world"], {}, [("q", u"hello\\ world")]),
    ),
    "query_by_phrase": (
        (["hello"], {}, [("q", u"hello")]),
        (
        ...
        ),  # Non-text data is always taken to be a term, and terms come before phrases, so order is reversed
        (["hello", "world"], {}, [("q", u"hello AND world")]),
        (["hello world"], {}, [("q", u"hello\\ world")]),
        (
            [],
            ...
            [
                (
                    "q",
                    u"string_field:goodbye,\\ cruel\\ world AND string_field:hello\\ world",
                )
            ],
        ),
    ),
    "filter_by_term": (
        ...
        (["hello", "world"], {}, [("fq", u"hello AND world"), ("q", "*:*")]),
        # NB this next is not really what we want,
        # probably this should warn
        (["hello world"], {}, [("fq", u"hello\\ world"), ("q", "*:*")]),
    ),
    "filter_by_phrase": (
        (["hello"], {}, [("fq", u"hello"), ("q", "*:*")]),
        (
    ...
    "query": (
        ...
        ([], {"boolean_field": True}, [("q", u"boolean_field:true")]),
        ([], {"boolean_field": "true"}, [("q", u"boolean_field:true")]),
        ([], {"boolean_field": 1}, [("q", u"boolean_field:true")]),
        ([], {"boolean_field": "false"}, [("q", u"boolean_field:false")]),
        ([], {"boolean_field": 0}, [("q", u"boolean_field:false")]),
        ([], {"boolean_field": False}, [("q", u"boolean_field:false")]),
        ([], {"int_field": 3}, [("q", u"int_field:3")]),
        (
            [],
            {"int_field": 3.1},  # casting from float should work
            [("q", u"int_field:3")],
        ),
        ([], {"sint_field": 3}, [("q", u"sint_field:3")]),
        (
            [],
            {"sint_field": 3.1},  # casting from float should work
            [("q", u"sint_field:3")],
        ),
        ([], {"long_field": 2 ** 31}, [("q", u"long_field:2147483648")]),
        ([], {"slong_field": 2 ** 31}, [("q", u"slong_field:2147483648")]),
        ([], {"float_field": 3.0}, [("q", u"float_field:3.0")]),
        (
            [],
            {"float_field": 3},  # casting from int should work
            [("q", u"float_field:3.0")],
        ),
        ([], {"sfloat_field": 3.0}, [("q", u"sfloat_field:3.0")]),
        (
            [],
            {"sfloat_field": 3},  # casting from int should work
            [("q", u"sfloat_field:3.0")],
        ),
        ([], {"double_field": 3.0}, [("q", u"double_field:3.0")]),
        (
            [],
            {"double_field": 3},  # casting from int should work
            [("q", u"double_field:3.0")],
        ),
        ([], {"sdouble_field": 3.0}, [("q", u"sdouble_field:3.0")]),
        (
            [],
        ...
        # Test ranges
        ([], {"int_field__any": True}, [("q", u"int_field:[* TO *]")]),
        ([], {"int_field__lt": 3}, [("q", u"int_field:{* TO 3}")]),
        ([], {"int_field__gt": 3}, [("q", u"int_field:{3 TO *}")]),
        (
            [],
        ...
        ([], {"int_field__lte": 3}, [("q", u"int_field:[* TO 3]")]),
        ([], {"int_field__gte": 3}, [("q", u"int_field:[3 TO *]")]),
        ([], {"int_field__range": (-3, 3)}, [("q", u"int_field:[\-3 TO 3]")]),
        ([], {"int_field__range": (3, -3)}, [("q", u"int_field:[\-3 TO 3]")]),
        (
            [],
        ...
        (
            ...
            [
                (
                    "q",
                    "date_field:{2009\\-01\\-01T00\\:00\\:00Z TO 2009\\-01\\-02T00\\:00\\:00Z}",
                )
            ],
        ),
        (
        ...
        (
            ...
            [
                (
                    "q",
                    u"date_field:[2009\\-01\\-01T00\\:00\\:00Z TO 2009\\-01\\-02T00\\:00\\:00Z]",
                )
            ],
        ),
        (
...
good_option_data = {
    PaginateOptions: (
        ({"start": 5, "rows": 10}, {"start": 5, "rows": 10}),
        ({"start": 5, "rows": None}, {"start": 5}),
        ({"start": None, "rows": 10}, {"rows": 10}),
    ),
    FacetOptions: (
        (
            {"fields": "int_field"},
        ...
        ({"prefix": "abc"}, {"facet": True, "facet.prefix": "abc"}),
        (
            {
                "prefix": "abc",
                "sort": True,
        ...
        (
            ...
            {
                "facet": True,
                "facet.field": ["int_field"],
                "f.int_field.facet.prefix": "abc",
            },
        ),
        (
        ...
        (
            ...
            {
                "facet": True,
                "facet.field": ["int_field", "text_field"],
                "f.int_field.facet.prefix": "abc",
                "f.int_field.facet.limit": 3,
                "f.text_field.facet.prefix": "abc",
                "f.text_field.facet.limit": 3,
            },
        ),
    ),
    SortOptions: (
        ({"field": "int_field"}, {"sort": "int_field asc"}),
        ({"field": "-int_field"}, {"sort": "int_field desc"}),
    ),
    HighlightOptions: (
        ({"fields": "int_field"}, {"hl": True, "hl.fl": "int_field"}),
        (
            {"fields": ["int_field", "text_field"]},
            {"hl": True, "hl.fl": "int_field,text_field"},
        ),
        ({"snippets": 3}, {"hl": True, "hl.snippets": 3}),
        (
            {
                "snippets": 3,
                "fragsize": 5,
                ...
                "maxAnalyzedChars": 500,
                "alternateField": "text_field",
            ...
            },
            {
                ...
                "hl.maxAnalyzedChars": 500,
                "hl.alternateField": "text_field",
                "hl.maxAlternateFieldLength": 50,
                "hl.formatter": "simple",
                "hl.simple.pre": "<b>",
                "hl.simple.post": "</b>",
                "hl.fragmenter": "regex",
        ...
        (
            {"fields": "int_field", "snippets": 3, "fragsize": 5},
            {
                "hl": True,
                "hl.fl": "int_field",
                "f.int_field.hl.snippets": 3,
                "f.int_field.hl.fragsize": 5,
            },
        ),
        (
            {
            ...
            {
                "hl": True,
                "hl.fl": "int_field,text_field",
                "f.int_field.hl.snippets": 3,
                "f.int_field.hl.fragsize": 5,
                "f.text_field.hl.snippets": 3,
                "f.text_field.hl.fragsize": 5,
            },
        ),
    ),
    MoreLikeThisOptions: (
        ({"fields": "int_field"}, {"mlt": True, "mlt.fl": "int_field"}),
        (
            {"fields": ["int_field", "text_field"]},
        ...
        (
            {
                "fields": ["text_field", "string_field"],
                "query_fields": {"text_field": 0.25, "string_field": 0.75},
            },
            {
                "mlt": True,
                "mlt.fl": "string_field,text_field",
                "mlt.qf": "text_field^0.25 string_field^0.75",
            },
        ),
        (
    ...
    FieldLimitOptions: (
        ({}, {}),
        ({"fields": "int_field"}, {"fl": "int_field"}),
        (
            {"fields": ["int_field", "text_field"]},
            {"fl": "int_field,text_field"},
        ),
        ({"score": True}, {"fl": "score"}),
        ({"all_fields": True, "score": True}, {"fl": "*,score"}),
        ({"fields": "int_field", "score": True}, {"fl": "int_field,score"}),
    ),
}
...
complex_boolean_queries = (
    (
        lambda q: q.query("hello world").filter(
            q.Q(text_field="tow") | q.Q(boolean_field=False, int_field__gt=3)
        ),
        [
            (
                "fq",
                u"text_field:tow OR (boolean_field:false AND int_field:{3 TO *})",
            ),
            ("q", u"hello\\ world"),
        ],
    ),
    (
        ...
        [
            (
                "fq",
                u"boolean_field:false AND text_field:tow AND int_field:{3 TO *}",
            ),
            ("q", u"hello\\ world"),
        ],
    ),
    ...
    (lambda q: q.query(~q.Q("hello world")), [("q", u"NOT hello\\ world")]),
    (
    ...
    (lambda q: q.query(q.Q("def") | q.Q(q.Q("xyz"))), [("q", u"def OR xyz")]),
    ...
    (lambda q: q.query(~q.Q(~q.Q("def"))), [("q", u"def")]),
    (lambda q: q.query(~q.Q(~q.Q(~q.Q("def")))), [("q", u"NOT def")]),
    ...
    (
        lambda q: q.query("blah").exclude(
            q.Q("abc") | q.Q("def") | q.Q("ghi")
        ),
    ...
    (
        lambda q: q.query("blah").query(
            q.Q("def", ~q.Q("pqr") | q.Q("mno")) ** 1.5
        ),
    ...
    (
        lambda q: q.query("blah")
        .query("blah2")
        .boost_relevancy(1.5, int_field=3),
        [("q", u"(blah AND blah2) OR (blah AND blah2 AND int_field:3^1.5)")],
    ),
    # And ranges
    (lambda q: q.query(int_field__any=True), [("q", u"int_field:[* TO *]")]),
    (
    ...
    (
        {
            "int": 3,
            "string": "string",
            u"\N{UMBRELLA}nicode": u"\N{UMBRELLA}nicode",
        },
        [
            ("int", "3"),
            ("string", "string"),
            ("\xe2\x98\x82nicode", "\xe2\x98\x82nicode"),
        ],
    ),
...
mlt_query_options_data = (
    ...
    (
        ...
        [
            ("mlt.fl", "string_field,text_field"),
            ("mlt.qf", "string_field^3.0"),
        ],
    ),
    (
        "text_field",
        {},
        {"mindf": 3, "interestingTerms": "details"},
        [
            ("mlt.fl", "text_field"),
        ...
        if self.highlighting:
            contents.append(
                E.lst(
                    ...
                    E.lst(
                        {"name": "0"},
                        E.arr({"name": "string_field"}, E.str("zero")),
                    ),
                )
            )
        return contents
...
class HighlightingMockConnection(MockConnection):
    def _handle_request(self, uri_obj, params, method, body, headers):
        ...
        if method == "GET" and uri_obj.path.endswith("/select/"):
            return (
                self.MockStatus(200),
                HighlightingMockResponse(highlighting, 0, 1).xml_response(),
            )
...
class MltMockResponse(MockResponse):
    def extra_response_parts(self):
        ...
        contents.append(E.result({"name": "response"}, create_doc("zero")))
        # More like this results
        contents.append(
            E.lst(
                {"name": "moreLikeThis"},
                E.result(
                    {"name": "zero", "numFound": "3", "start": "0"},
                    create_doc("one"),
                    create_doc("two"),
                    create_doc("three"),
                ),
...
mlt_interface = SolrInterface(
    "http://test.example.com/", http_connection=MltMockConnection()
)
