...
info_tips = (
    ...
    'We <a href="https://github.com/freelawproject/judge-pics" target="_blank">have a collection of more than 200 judicial portraits</a> and we need volunteers to help collect them all.',
