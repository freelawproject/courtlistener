# -*- coding: utf-8 -*-
# Generated by Django 1.11.29 on 2020-12-24 00:53
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('people_db', '0046_auto_20201223_1653'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('addendum_content_raw', models.TextField(blank=True, help_text='Raw content of addendum.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value_code', models.TextField(blank=True, choices=[('J', '1 - 15,000'), ('K', '15,001 - 50,000'), ('L', '50,001 - 100,000'), ('M', '100,001 - 250,000'), ('N', '250,001 - 500,000'), ('O', '500,001 - 1,000,000'), ('P1', '1,000,001 - 5,000,000'), ('P2', '5,000,001 - 25,000,000'), ('P3', '25,000,001 - 50,000,000'), ('P4', '50,000,001 - '), ('•', 'Failed Extraction')], help_text='Value of the judicial gift, as Value Code.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(auto_now_add=True, db_index=True, help_text='The original creation date for the item')),
                ('date_modified', models.DateTimeField(auto_now=True, db_index=True, help_text='The last moment when the item was modified.')),
                ('page_number', models.IntegerField(help_text='The page the investment is listed on')),
                ...
                ('gross_value_method', models.CharField(blank=True, choices=[('Appraisal', 'Appraisal'), ('Cost (Real Estate Only)', 'Cost (Real Estate Only)'), ('Assessment', 'Assessment'), ('Cash Market', 'Cash Market'), ('Book Value', 'Book Value'), ('Other', 'Other'), ('•', 'Failed Extraction')], help_text='Investment valuation method code', max_length=5)),
                ...
                ('transaction_value_code', models.CharField(blank=True, choices=[('J', '1 - 15,000'), ('K', '15,001 - 50,000'), ('L', '50,001 - 100,000'), ('M', '100,001 - 250,000'), ('N', '250,001 - 500,000'), ('O', '500,001 - 1,000,000'), ('P1', '1,000,001 - 5,000,000'), ('P2', '5,000,001 - 25,000,000'), ('P3', '25,000,001 - 50,000,000'), ('P4', '50,000,001 - '), ('•', 'Failed Extraction')], help_text='Transaction value amount, as form code', max_length=5)),
                ('transaction_gain_code', models.CharField(blank=True, choices=[('A', '1 - 1,000'), ('B', '1,001 - 2,500'), ('C', '2,501 - 5,000'), ('D', '5,001 - 15,000'), ('E', '15,001 - 50,000'), ('F', '50,001 - 100,000'), ('G', '100,001 - 1,000,000'), ('H1', '1,000,001 - 5,000,000'), ('H2', '5,000,001 +'), ('•', 'Failed Extraction')], help_text='Gain from investment transaction if any', max_length=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization_name', models.TextField(blank=True, help_text='Name of organization or entity.')),
