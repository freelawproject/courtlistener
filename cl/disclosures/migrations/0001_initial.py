    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filepath', models.FileField(db_index=True, help_text='The filepath to the disclosure normalized to a PDF.', storage=cl.lib.storage.IncrementingAWSMediaStorage(), upload_to=cl.disclosures.models.pdf_path)),
                ('thumbnail', models.FileField(blank=True, help_text='A thumbnail of the first page of the disclosure form.', null=True, storage=cl.lib.storage.IncrementingAWSMediaStorage(), upload_to=cl.disclosures.models.thumbnail_path)),
