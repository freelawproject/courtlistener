...
RT_PERCOLATOR_OPINIONS_SEARCH_ALERTS_ENABLED = env(
    "RT_PERCOLATOR_OPINIONS_SEARCH_ALERTS_ENABLED", default=False
)
DLY_PERCOLATOR_OPINIONS_SEARCH_ALERTS_ENABLED = env(
    "DLY_PERCOLATOR_OPINIONS_SEARCH_ALERTS_ENABLED", default=False
)
WLY_PERCOLATOR_OPINIONS_SEARCH_ALERTS_ENABLED = env(
    "WLY_PERCOLATOR_OPINIONS_SEARCH_ALERTS_ENABLED", default=False
)
MLY_PERCOLATOR_OPINIONS_SEARCH_ALERTS_ENABLED = env(
    "MLY_PERCOLATOR_OPINIONS_SEARCH_ALERTS_ENABLED", default=False
)
INDEXING_PERCOLATOR_OPINIONS_SEARCH_ALERTS_ENABLED = env(
    "INDEXING_PERCOLATOR_OPINIONS_SEARCH_ALERTS_ENABLED", default=False
)
