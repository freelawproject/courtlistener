...
DOCKET_NUMBER_CLEANING_API_KEY = env(
    "DOCKET_NUMBER_CLEANING_API_KEY", default=None
)
DOCKET_NUMBER_CLEANING_TEMPERATURE = env.float(
    "DOCKET_NUMBER_CLEANING_TEMPERATURE", default=0.1
)
DOCKET_NUMBER_CLEANING_MAX_COMPLETION_TOKENS = env.int(
    "DOCKET_NUMBER_CLEANING_MAX_COMPLETION_TOKENS", default=1000
)
DOCKET_NUMBER_CLEANING_MINI_MODEL_ONE = env(
    "DOCKET_NUMBER_CLEANING_MINI_MODEL_ONE", default="gpt-4o-mini"
)
DOCKET_NUMBER_CLEANING_MINI_MODEL_TWO = env(
    "DOCKET_NUMBER_CLEANING_MINI_MODEL_TWO", default="gpt-4.1-mini"
)
DOCKET_NUMBER_CLEANING_FULL_MODEL_ONE = env(
    "DOCKET_NUMBER_CLEANING_FULL_MODEL_ONE", default="gpt-4o"
)
DOCKET_NUMBER_CLEANING_FULL_MODEL_TWO = env(
    "DOCKET_NUMBER_CLEANING_FULL_MODEL_TWO", default="gpt-4.1"
)
DOCKET_NUMBER_CLEANING_TIE_BREAKER_MODEL = env(
    "DOCKET_NUMBER_CLEANING_TIE_BREAKER_MODEL", default="gpt-4o"
)
