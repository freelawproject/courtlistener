...
--
-- Add field sort_desc to userprofile
--
ALTER TABLE "users_userprofile" ADD COLUMN "sort_desc" boolean DEFAULT false NOT NULL;
ALTER TABLE "users_userprofile" ALTER COLUMN "sort_desc" DROP DEFAULT;
--
-- Add field sort_desc to userprofileevent
--
ALTER TABLE "users_userprofileevent" ADD COLUMN "sort_desc" boolean DEFAULT false NOT NULL;
ALTER TABLE "users_userprofileevent" ALTER COLUMN "sort_desc" DROP DEFAULT;
--
...
--
            ...
            COMMENT ON TRIGGER pgtrigger_snapshot_insert_31610 ON "users_userprofile" IS '02f2f5e685022d8fb241253c4c910080930df96e';
        ;
--
...
--
            ...
            COMMENT ON TRIGGER pgtrigger_snapshot_update_74231 ON "users_userprofile" IS '13f8f9af76ad16aa2e58c286f294be4c88a60421';
        ;
COMMIT;
