...
--
-- Add field docket_default_order_desc to userprofile
--
ALTER TABLE "users_userprofile"
    ADD COLUMN "docket_default_order_desc" boolean DEFAULT false NOT NULL;
ALTER TABLE "users_userprofile"
    ALTER COLUMN "docket_default_order_desc" DROP DEFAULT;
--
-- Add field docket_default_order_desc to userprofileevent
--
...
BEGIN
    ...
    INSERT INTO "users_userprofileevent" ("activation_key", "address1",
                                          ...
                                          "plaintext_preferred", "recap_email",
                                          "state", "stub_account",
                                          "unlimited_docket_alerts", "user_id",
                                          "wants_newsletter", "zip_code")
    VALUES (NEW."activation_key", NEW."address1", NEW."address2",
            NEW."auto_subscribe", NEW."avatar", NEW."city",
            NEW."docket_default_order_desc", NEW."email_confirmed",
            NEW."employer", NEW."id", NEW."is_tester", NEW."key_expires",
            NEW."notes", _pgh_attach_context(), NOW(), 'snapshot', NEW."id",
            NEW."plaintext_preferred", NEW."recap_email", NEW."state",
            NEW."stub_account", NEW."unlimited_docket_alerts", NEW."user_id",
            NEW."wants_newsletter", NEW."zip_code");
    RETURN NULL;
END;
$$ LANGUAGE plpgsql;
