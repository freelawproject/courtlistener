    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('docket', models.ForeignKey(related_name='alerts', to='search.Docket', help_text='The docket that we are subscribed to.', on_delete=models.CASCADE)),
                ('user', models.ForeignKey(related_name='docket_alerts', to=settings.AUTH_USER_MODEL, help_text='The user that is subscribed to the docket.',
