...
--
-- Add field es_id to alertevent
--
ALTER TABLE "alerts_alertevent" ADD COLUMN "es_id" varchar(128) DEFAULT '' NOT NULL;
ALTER TABLE "alerts_alertevent" ALTER COLUMN "es_id" DROP DEFAULT;
--
