...
--
CREATE TABLE "alerts_scheduledalerthit" ("id" integer NOT NULL PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY, "date_created" timestamp with time zone NOT NULL, "date_modified" timestamp with time zone NOT NULL, "rate" varchar(10) NOT NULL, "document_content" jsonb NOT NULL, "hit_status" smallint NOT NULL);
--
