    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_last_hit', models.DateTimeField(blank=True, help_text='The last date on which an email was received for the case.', null=True, verbose_name='The last date on which an email was received for the case.')),
                ('secret_key', models.CharField(help_text='A key to be used in links to access the alert without having to log in. Can be used for a variety of purposes.', max_length=40, verbose_name='A key to be used in links to access the alert without having to log in. Can be used for a variety of purposes.')),
