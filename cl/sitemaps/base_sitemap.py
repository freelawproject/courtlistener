...
class InfinitePaginatorSitemap(sitemaps.Sitemap):
    ...
    This sitemap is intended to be pre-generated by a Celery task rather than generated on-the-fly,
    ...
    def get_urls(
        ...
        as it is intended to be pre-generated by a Celery task rather than generated on-the-fly.
        """
        raise InvalidPage(
            "This sitemap uses 'seek pagination' and should be pregenerated by running celery task: `generate_urls_chunk`."
        )
