...
def create_cited_html(opinion, citations):
    if any([opinion.html_columbia, opinion.html_lawbox, opinion.html]):
        ...
        # Clean up any unbalanced HTML tags
        # (The HTML generated by our regex substitution is itself properly
        #  balanced; the problem is that there might be other intervening tags
        #  in the raw text that may mess things up.)
        new_html = Cleaner(remove_unknown_tags=False).clean_html(new_html)
    elif opinion.plain_text:
