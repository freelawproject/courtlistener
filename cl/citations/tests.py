...
class CitationTextTest(SimpleTestCase):
    ...
    def test_make_html_from_matched_citation_objects(self) -> None:
        ...
        test_pairs = [
            ...
            f'<pre class="inline">In Strong v. Waterman, the court held that a trustee must act in good faith and in the best interest of the beneficiaries. </pre><span class="citation" data-id="MATCH_ID"><a href="MATCH_URL" {aria_description}>11 Paige 607</a></span><pre class="inline">. It further clarified that a trustee’s discretion remains subject to judicial review. </pre><span class="citation short-case-citation" data-id="MATCH_ID"><a href="MATCH_URL#611" {aria_description}>11 Paige at 611</a></span><pre class="inline">. This principle had been previously established. </pre><span class="citation supra-citation" data-id="MATCH_ID"><a href="MATCH_URL#609" {aria_description}>Supra, at 609</a></span><pre class="inline">. The court reaffirmed this rule. </pre><span class="citation id-citation" data-id="MATCH_ID"><a href="MATCH_URL#609" {aria_description}>Id. at 609</a></span><pre class="inline">.</pre>'),

            # Annotate reference citation
            ('Foo v. Bar 1 U.S. 1. In Foo at 2.', f'<pre class="inline">Foo v. Bar </pre><span class="citation" data-id="MATCH_ID"><a href="MATCH_URL" {aria_description}>1 U.S. 1</a></span><pre class="inline">. In </pre><span class="citation reference-citation" data-id="MATCH_ID"><a href="MATCH_URL#2" {aria_description}>Foo at 2</a></span><pre class="inline">.</pre>')
