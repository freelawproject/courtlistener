    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_start', models.DateField(db_index=True, null=True, blank=True)),
                ('date_granularity_start', models.CharField(blank=True, max_length=15, choices=[(b'%Y', b'Year'), (b'%Y-%m', b'Month'), (b'%Y-%m-%d', b'Day')])),
                ('date_end', models.DateField(help_text=b'The date a judge stopped holding a specific job. If the actual date is unknown, this is a date prior to when they became a judge.', null=True, db_index=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_last', models.CharField(max_length=50, db_index=True)),
                ('name_suffix', models.CharField(blank=True, max_length=5, choices=[(b'jr', b'Jr.'), (b'sr', b'Sr.'), (b'1', b'I'), (b'2', b'II'), (b'3', b'III'), (b'4', b'IV')])),
                ('office', models.CharField(max_length=5, choices=[(b'p', b'President'), (b'g', b'Governor')])),
            ],
        ),
        migrations.CreateModel(
            name='Position',
            fields=[
                ...
                ('date_start', models.DateField(help_text=b'The date a judge starts active duty.', db_index=True)),
                ...
                ('how_selected', models.CharField(max_length=20, choices=[(b'e_part', b'Partisan Election'), (b'e_non_part', b'Non-Partisan Election'), (b'a_pres', b'Appointment (Governor)'), (b'a_gov', b'Appointment (President)'), (b'a_legis', b'Appointment (Legislature)')])),
                ...
                ('appointer', models.ForeignKey(blank=True, to='judges.Politician', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Race',
