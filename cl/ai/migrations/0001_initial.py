    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task', models.SmallIntegerField(choices=[(1, 'Extract text from scan'), (2, 'Extract text from scraped documents'), (3, 'Case Name Extraction'), (4, 'Clean Docket Numbers')], help_text='The task to run.')),
