    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(auto_now_add=True, db_index=True, help_text='The moment when the item was created.')),
                ('date_modified', models.DateTimeField(auto_now=True, db_index=True, help_text='The last moment when the item was modified. A value in year 1750 indicates the value is unknown')),
                ('name', models.CharField(blank=True, help_text='Human-readable request name', max_length=255)),
                ('is_batch', models.BooleanField(default=False, help_text='Whether this is a batch request or single request')),
                ...
                ('api_model_name', models.CharField(blank=True, help_text='Specific model version (e.g., gemini-2.0-flash, claude-opus-4.1)', max_length=100)),
                ('status', models.SmallIntegerField(choices=[(0, 'Unprocessed'), (1, 'In Progress'), (2, 'Succeeded'), (3, 'Failed'), (4, 'Finished')], db_index=True, default=0, help_text='The current status of the request')),
                ...
                ('extra_config_params', models.JSONField(blank=True, default=dict, help_text='Additional input data or parameters for the LLM', null=True)),
                ('batch_response_file', models.FileField(blank=True, help_text='The batch response file from the LLM provider (e.g., a JSONL file)', max_length=1000, storage=cl.lib.storage.IncrementingAWSMediaStorage(), upload_to=cl.ai.models.make_response_file_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(auto_now_add=True, db_index=True, help_text='The moment when the item was created.')),
                ('date_modified', models.DateTimeField(auto_now=True, db_index=True, help_text='The last moment when the item was modified. A value in year 1750 indicates the value is unknown')),
                ('status', models.SmallIntegerField(choices=[(0, 'Unprocessed'), (1, 'In Progress'), (2, 'Succeeded'), (3, 'Failed'), (4, 'Finished')], db_index=True, default=0, help_text='The current status of the task')),
                ('llm_key', models.CharField(help_text='The LLM key for this task', max_length=255)),
                ('task', models.SmallIntegerField(choices=[(1, 'Extract text from scan'), (2, 'Extract text from scraped documents'), (3, 'Case Name Extraction'), (4, 'Clean Docket Numbers')], db_index=True, help_text='The task to run.')),
                ...
                ('input_file', models.FileField(blank=True, help_text='The input file to be processed (PDF, text, etc.)', max_length=1000, storage=cl.lib.storage.IncrementingAWSMediaStorage(), upload_to=cl.ai.models.make_input_file_path)),
                ('response_file', models.FileField(blank=True, help_text='Full response from the LLM provider stored as a file', max_length=1000, storage=cl.lib.storage.IncrementingAWSMediaStorage(), upload_to=cl.ai.models.make_response_file_path)),
