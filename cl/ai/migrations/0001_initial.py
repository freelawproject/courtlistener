    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.SmallIntegerField(choices=[(0, 'Unprocessed'), (1, 'In Progress'), (2, 'LLM response received'), (3, 'Failed'), (4, 'LLM response processed')], default=0, help_text='The current status of the request')),
                ...
                ('batch_response_file', models.FileField(blank=True, help_text='The batch response file from the LLM provider (e.g., a JSONL file)', max_length=1000, storage=cl.lib.storage.S3PrivateLLMStorage(), upload_to=cl.lib.model_helpers.make_llm_request_response_file_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(auto_now_add=True, db_index=True, help_text='The moment when the item was created.')),
                ('date_modified', models.DateTimeField(auto_now=True, db_index=True, help_text='The last moment when the item was modified. A value in year 1750 indicates the value is unknown')),
                ('status', models.SmallIntegerField(choices=[(0, 'Unprocessed'), (1, 'In Progress'), (2, 'LLM response received'), (3, 'Failed'), (4, 'LLM response processed')], default=0, help_text='The current status of the task')),
                ('llm_key', models.CharField(help_text='A unique identifier from the LLM provider for this task, used to map results back from a batch job.', max_length=255)),
                ('task_type', models.SmallIntegerField(choices=[(1, 'Extract text from scan'), (2, 'Extract text from scraped documents'), (3, 'Case Name Extraction'), (4, 'Clean Docket Numbers')], help_text='The specific type of operation this task represents.')),
                ...
                ('input_file', models.FileField(blank=True, help_text='The input file to be processed (PDF, text, etc.)', max_length=1000, storage=cl.lib.storage.S3PrivateLLMStorage(), upload_to=cl.lib.model_helpers.make_llm_task_input_file_path)),
                ('input_text', models.TextField(blank=True, help_text='Text input for the task, if not using a file.')),
                ('response_file', models.FileField(blank=True, help_text='Full response from the LLM provider stored as a file', max_length=1000, storage=cl.lib.storage.S3PrivateLLMStorage(), upload_to=cl.lib.model_helpers.make_llm_task_response_file_path)),
                ...
                ('content_type', models.ForeignKey(blank=True, db_index=False, help_text='Content type of the related object', null=True, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.contenttype')),
