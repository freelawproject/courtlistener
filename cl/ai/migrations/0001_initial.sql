...
--
CREATE TABLE "ai_llmtask" ("id" integer NOT NULL PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY, "date_created" timestamp with time zone NOT NULL, "date_modified" timestamp with time zone NOT NULL, "status" smallint NOT NULL, "llm_key" varchar(255) NOT NULL, "task_type" smallint NOT NULL, "retry_count" smallint NOT NULL, "error_message" text NOT NULL, "input_file" varchar(1000) NOT NULL, "input_text" text NOT NULL, "response_file" varchar(1000) NOT NULL, "processing_time_ms" integer NULL, "date_started" timestamp with time zone NULL, "date_completed" timestamp with time zone NULL, "object_id" integer NULL CHECK ("object_id" >= 0), "content_type_id" integer NULL, "request_id" integer NULL);
