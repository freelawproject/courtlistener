...
# Create a new nested router for the transcript endpoint
audio_router = routers.NestedSimpleRouter(router, r"audio", lookup="audio")
audio_router.register(
    r"transcripts", audio_views.TranscriptViewSet, basename="audio-transcripts"
)
...
urlpatterns = [
    ...
    re_path(r"^api/rest/(?P<version>[v3]+)/", include(audio_router.urls)),
