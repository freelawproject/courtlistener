...
--
-- Create model APIThrottleHistoryEvent
--
CREATE TABLE "api_apithrottlehistoryevent" (
...
CREATE INDEX "api_apithrottlehistoryevent_pgh_context_id_922c3015" ON "api_apithrottlehistoryevent" ("pgh_context_id");
CREATE INDEX "api_apithrottlehistoryevent_pgh_obj_id_742b6d44" ON "api_apithrottlehistoryevent" ("pgh_obj_id");
CREATE INDEX "api_apithrottlehistoryevent_user_id_3921973b" ON "api_apithrottlehistoryevent" ("user_id");
COMMIT;
