// Version 2.12.1 timelines-chart - https://github.com/ERosendo/timelines-chart
!(function (t, n) {
  'object' == typeof exports && 'undefined' != typeof module
    ? (module.exports = n())
    : 'function' == typeof define && define.amd
    ? define(n)
    : ((t = 'undefined' != typeof globalThis ? globalThis : t || self).TimelinesChart = n());
})(this, function () {
  'use strict';
  function t(t) {
    return (
  ...
  function o(t, n) {
    return (
        ...
        if (null != e) {
          ...
          try {
            if (((a = (e = e.call(t)).next), 0 === n)) {
              ...
              l = !1;
            } else for (; !(l = (r = a.call(e)).done) && (u.push(r.value), u.length !== n); l = !0);
          } catch (t) {
            (s = !0), (i = t);
          } finally {
            try {
              if (!l && null != e.return && ((o = e.return()), Object(o) !== o)) return;
            } finally {
              if (s) throw i;
            }
          }
      ...
      (function (t, n) {
        ...
        if ('Arguments' === e || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e)) return u(t, n);
      })(t, n) ||
      (function () {
        throw new TypeError(
  ...
  function s(t) {
    ...
    return function () {
      ...
      var u = function (t, e) {
          p.call(a, t, n, e), (n.initialised = !0);
        },
        l = r(function () {
  ...
  function h(t) {
    ...
    return (
      2 !== t.length
        ? ((n = c), (e = (n, e) => c(t(n), e)), (r = (n, e) => t(n) - e))
        : ((n = t === c || t === f ? t : p), (e = t), (r = t)),
      {
        left: i,
      ...
      (_ = _.merge(_.enter().insert('path', '.tick').attr('class', 'domain').attr('stroke', 'currentColor'))),
        ...
        (k = k.merge(
          A.append('text')
            ...
            .attr(c, s * d)
            .attr('dy', t === D ? '0em' : t === z ? '0.71em' : '0.32em')
        )),
        h !== w &&
          ((_ = _.transition(h)),
          (x = x.transition(h)),
        ...
        _.attr(
          ...
          t === E || t === N
            ? o
              ? 'M' + s * o + ',' + v + 'H' + l + 'V' + y + 'H' + s * o
              : 'M' + l + ',' + v + 'V' + y
            : o
            ? 'M' + v + ',' + s * o + 'V' + l + 'H' + y + 'V' + s * o
            : 'M' + v + ',' + l + 'H' + y
        ),
        ...
        w
          ...
          .attr('text-anchor', t === N ? 'start' : t === E ? 'end' : 'middle'),
        w.each(function () {
          this.__axis = b;
        });
    }
      ...
      (n = et.exec(t))
        ? ((e = n[1].length),
          ...
          6 === e
            ? pt(n)
            : 3 === e
            ? new mt(((n >> 8) & 15) | ((n >> 4) & 240), ((n >> 4) & 15) | (240 & n), ((15 & n) << 4) | (15 & n), 1)
            : 8 === e
            ? gt((n >> 24) & 255, (n >> 16) & 255, (n >> 8) & 255, (255 & n) / 255)
            : 4 === e
            ? gt(
                ((n >> 12) & 15) | ((n >> 8) & 240),
                ((n >> 8) & 15) | ((n >> 4) & 240),
        ...
        : (n = it.exec(t))
        ? new mt((255 * n[1]) / 100, (255 * n[2]) / 100, (255 * n[3]) / 100, 1)
        : (n = at.exec(t))
        ? gt(n[1], n[2], n[3], n[4])
        : (n = ot.exec(t))
        ? gt((255 * n[1]) / 100, (255 * n[2]) / 100, (255 * n[3]) / 100, n[4])
        : (n = ut.exec(t))
  ...
  function dt(t, n, e, r) {
    return 1 === arguments.length
      ? ((i = t) instanceof Z || (i = ht(i)), i ? new mt((i = i.rgb()).r, i.g, i.b, i.opacity) : new mt())
      : new mt(t, n, e, null == r ? 1 : r);
    var i;
  }
  function mt(t, n, e, r) {
  ...
  function Mt(t) {
    ...
    if ((t instanceof Z || (t = ht(t)), !t)) return new At();
    ...
    return (
      u
        ? ((o = n === a ? (e - r) / u + 6 * (e < r) : e === a ? (r - n) / u + 2 : (n - e) / u + 4),
          (u /= l < 0.5 ? a + i : 2 - a - i),
          (o *= 60))
        : (u = l > 0 && l < 1 ? 0 : o),
  ...
  W(Z, ht, {
    ...
    W(
      ...
      G(Z, {
        ...
        formatHsl() {
          const t = bt(this.opacity);
          return `${1 === t ? 'hsl(' : 'hsla('}${St(this.h)}, ${100 * kt(this.s)}%, ${100 * kt(this.l)}%${
            1 === t ? ')' : `, ${t})`
          }`;
        },
      })
    ...
    Ft =
        ...
        return function (e) {
          ...
          return (function (t, n, e, r, i) {
            var a = t * t,
              o = a * t;
            return (
              ((1 - 3 * t + 3 * a - o) * n + (4 - 6 * a + 3 * o) * e + (1 + 3 * t + 3 * a - 3 * o) * r + o * i) / 6
            );
          })((e - r / n) * n, o, i, a, u);
        };
      }),
      function (t) {
        var n,
          ...
          a = new Array(r),
          o = new Array(r);
        for (n = 0; n < r; ++n) (e = dt(t[n])), (i[n] = e.r || 0), (a[n] = e.g || 0), (o[n] = e.b || 0);
        return (
          (i = Et(i)),
          (a = Et(a)),
          (o = Et(o)),
  ...
  var qt,
    Bt = 180 / Math.PI,
    Xt = { translateX: 0, translateY: 0, rotate: 0, skewX: 0, scaleX: 1, scaleY: 1 };
  function Vt(t, n, e, r, i, a) {
    ...
    return (
      ...
      { translateX: i, translateY: a, rotate: Math.atan2(n, t) * Bt, skewX: Math.atan(l) * Bt, scaleX: o, scaleY: u }
    );
  }
  function Wt(t, n, e, r) {
    function i(t) {
  ...
  var Gt = Wt(
    ...
    Zt = Wt(
      function (t) {
        return null == t
          ? Xt
          : (qt || (qt = document.createElementNS('http://www.w3.org/2000/svg', 'g')),
  ...
  function nn(t, n, e) {
    var r = t[0],
      ...
      o = n[1];
    return (
      i < r ? ((r = tn(i, r)), (a = e(o, a))) : ((r = tn(r, i)), (a = e(a, o))),
      function (t) {
        return a(r(t));
      }
    );
  ...
  function en(t, n, e) {
    ...
    for (t[r] < t[0] && ((t = t.slice().reverse()), (n = n.slice().reverse())); ++o < r; )
      (i[o] = tn(t[o], t[o + 1])), (a[o] = e(n[o], n[o + 1]));
    return function (n) {
      var e = d(t, n, 1, r) - 1;
      return a[e](i[e](n));
    };
  ...
  var sn,
    cn = /^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;
  function fn(t) {
    if (!(n = cn.exec(t))) throw new Error('invalid format: ' + t);
    var n;
    return new hn({
      fill: n[1],
      align: n[2],
  ...
  var gn = {
    ...
    s: function (t, n) {
      ...
      return a === o
        ...
        : '0.' + new Array(1 - a).join('0') + un(t, Math.max(0, n + a - 1))[0];
    },
          ...
          : ((n = bn.call(t.grouping, Number)),
            ...
            function (t, r) {
              for (
                ...
                i > 0 &&
                u > 0 &&
                (l + u + 1 > r && (u = Math.max(1, r - l)), a.push(t.substring((i -= u), i + u)), !((l += u + 1) > r));
    ...
    return (
      ...
      (t.nice = function (e) {
        ...
        for (s < l && ((i = l), (l = s), (s = i), (i = o), (o = u), (u = i)); c-- > 0; ) {
          if ((i = M(l, s, e)) === r) return (a[o] = l), (a[u] = s), n(a);
  ...
  (mn = _n({ thousands: ',', grouping: [3], currency: ['$', ''] })), (vn = mn.format), (yn = mn.formatPrefix);
  const Sn = new Date(),
    kn = new Date();
  function Cn(t, n, e, r) {
    function i(n) {
    ...
    return (
      ...
      e &&
        ((i.count = (n, r) => (Sn.setTime(+n), kn.setTime(+r), t(Sn), t(kn), Math.floor(e(Sn, kn)))),
        (i.every = (t) => (
          (t = Math.floor(t)),
  ...
  const jn = Cn(
    ...
    (t, n) => (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * Nn) / En,
    (t) => t.getDate() - 1
  );
  jn.range;
  const $n = Cn(
  ...
  Bn.range, Xn.range, Vn.range, Wn.range, Gn.range, Zn.range, Qn.range;
  const Kn = Jn(0),
    te = Jn(1),
    ne = Jn(2),
    ee = Jn(3),
    ...
    ie = Jn(5),
    ae = Jn(6);
  Kn.range, te.range, ne.range, ee.range, re.range, ie.range, ae.range;
  const oe = Cn(
    (t) => {
  ...
  function ce(t, n, e, r, i, a) {
    ...
    function u(n, e, r) {
      const i = Math.abs(e - n) / r,
        a = h(([, , t]) => t).right(o, i);
      if (a === o.length) return t.every(A(n / Ln, e / Ln, r));
      if (0 === a) return Tn.every(Math.max(A(n, e, r), 1));
  ...
  function Pr(t, n, e, r, i, a, o, u, l, s) {
    ...
    function _(t) {
      return (
        l(t) < t ? p : u(t) < t ? g : o(t) < t ? d : a(t) < t ? m : r(t) < t ? (i(t) < t ? v : y) : e(t) < t ? b : w
      )(t);
    }
    return (
      (c.invert = function (t) {
  ...
  function jr() {
    return j.apply(
      Pr(pe, ge, le, oe, Bn, jn, On, Rn, Un, be).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]),
      arguments
    );
  }
  function $r() {
    return j.apply(
      Pr(fe, he, se, ue, Kn, $n, Pn, Yn, Un, we).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)]),
      arguments
    );
  }
  function Ir() {
      ...
      (function () {
        ...
        function s(n) {
          return null == n || isNaN((n = +n))
            ? i
            : u(0 === e ? 0.5 : ((n = (r(n) - t) * e), l ? Math.max(0, Math.min(1, n)) : n));
        }
        function c(t) {
          return function (n) {
            var e, r;
        ...
        return (
          (s.domain = function (i) {
            return arguments.length
              ? (([a, o] = i), (t = r((a = +a))), (n = r((o = +o))), (e = t === n ? 0 : 1 / (n - t)), s)
              : [a, o];
          }),
          (s.clamp = function (t) {
      ...
      function A(t, n, e, r) {
        for (var i, a, o = 0, u = n.length, l = e.length; o < u; ) {
          ...
          if (37 === (i = n.charCodeAt(o++))) {
            if (((i = n.charAt(o++)), !(a = _[i in _e ? n.charAt(o++) : i]) || (r = a(t, e, r)) < 0)) return -1;
  ...
  function Xr(t) {
    ...
    return (
      ...
      Br.hasOwnProperty(n) ? { space: Br[n], local: t } : t
    );
  }
  function Vr(t) {
    return function () {
  ...
  ta.prototype = na.prototype = {
    ...
    attr: function (t, n) {
      ...
      return this.each(
        (null == n ? (e.local ? di : gi) : 'function' == typeof n ? (e.local ? bi : yi) : e.local ? vi : mi)(e, n)
      );
    },
    style: function (t, n, e) {
      return arguments.length > 1
        ? this.each((null == n ? _i : 'function' == typeof n ? Mi : xi)(t, n, null == e ? '' : e))
        : Ai(this.node(), t);
    },
    property: function (t, n) {
      return arguments.length > 1
        ? this.each((null == n ? Si : 'function' == typeof n ? Ci : ki)(t, n))
        : this.node()[t];
    },
    ...
    text: function (t) {
      return arguments.length
        ? this.each(null == t ? Ui : ('function' == typeof t ? Yi : Ri)(t))
        : this.node().textContent;
    },
    html: function (t) {
      return arguments.length
        ? this.each(null == t ? Oi : ('function' == typeof t ? ji : Pi)(t))
        : this.node().innerHTML;
    },
    raise: function () {
      return this.each($i);
    ...
    on: function (t, n, e) {
      var r,
        ...
        o = a.length;
      if (!(arguments.length < 2)) {
        for (u = n ? Gi : Wi, r = 0; r < o; ++r) this.each(u(a[r], n, e));
        return this;
      }
      var u = this.node().__on;
      if (u)
        for (var l, s = 0, c = u.length; s < c; ++s)
          for (r = 0, l = u[s]; r < o; ++r) if ((i = a[r]).type === l.type && i.name === l.name) return l.value;
    },
  ...
  aa.prototype = oa.prototype = {
    ...
    clear: function () {
      for (var t in this) t[0] === ia && delete this[t];
    },
    keys: function () {
      var t = [];
      for (var n in this) n[0] === ia && t.push(n.slice(1));
      return t;
    },
    values: function () {
      var t = [];
      for (var n in this) n[0] === ia && t.push(this[n]);
      return t;
    },
    entries: function () {
      var t = [];
      for (var n in this) n[0] === ia && t.push({ key: n.slice(1), value: this[n] });
      return t;
    },
    size: function () {
      var t = 0;
      for (var n in this) n[0] === ia && ++t;
      return t;
    },
    empty: function () {
      for (var t in this) if (t[0] === ia) return !1;
      return !0;
    },
    each: function (t) {
      for (var n in this) n[0] === ia && t(this[n], n.slice(1), this);
    },
  };
  var la = oa.prototype;
  ua.prototype = {
  ...
  function fa(t) {
    ...
    return (
      e >= 0 && 'xmlns' !== (n = t.slice(0, e)) && (t = t.slice(e + 1)),
      ca.hasOwnProperty(n) ? { space: ca[n], local: t } : t
    );
  }
  function ha(t) {
    return function () {
  ...
  function xa(t, n, e, r, i, a, o) {
    ...
    for (u = 0; u < h; ++u)
      (l = c[(s = wa + o.call(t, a[u], u, a))])
        ? ((r[u] = l), (l.__data__ = a[u]), (c[s] = null))
        : (e[u] = new ba(t, a[u]));
    for (u = 0; u < f; ++u) (l = n[u]) && c[p[u]] === l && (i[u] = l);
  }
  function Ma(t, n) {
    return t < n ? -1 : t > n ? 1 : t >= n ? 0 : NaN;
  }
  ...
  function Oa(t) {
    (this._node = t), (this._names = Ra(t.getAttribute('class') || ''));
  }
  function Pa(t, n) {
    for (var e = Ya(t), r = -1, i = n.length; ++r < i; ) e.add(n[r]);
  }
  function ja(t, n) {
    for (var e = Ya(t), r = -1, i = n.length; ++r < i; ) e.remove(n[r]);
  }
  function $a(t) {
    return function () {
      Pa(this, t);
  ...
  'undefined' != typeof document &&
    ('onmouseenter' in document.documentElement || (ro = { mouseenter: 'mouseover', mouseleave: 'mouseout' }));
  function io(t, n, e) {
    return (
      (t = ao(t, n, e)),
      function (n) {
  ...
  function mo() {
    ...
    (l.show = function () {
      ...
      for (g.html(o).style('opacity', 1).style('pointer-events', 'all'); d--; ) g.classed(c[d], !1);
      return (
        (a = s.get(p).apply(this)),
        g
          .classed(p, !0)
    ...
    var s = oa({
        n: function () {
          var t = p(this);
          return { top: t.n.y - i.offsetHeight, left: t.n.x - i.offsetWidth / 2 };
        },
        s: function () {
          var t = p(this);
        ...
        w: function () {
          var t = p(this);
          return { top: t.w.y - i.offsetHeight / 2, left: t.w.x - i.offsetWidth };
        },
        nw: function () {
          var t = p(this);
  ...
  ho.prototype = po.prototype = {
    ...
    merge: function (t) {
      for (
        var n = this._groups, e = t._groups, r = n.length, i = e.length, a = Math.min(r, i), o = new Array(r), u = 0;
        u < a;
        ++u
      )
    ...
    attr: function (t, n) {
      ...
      return this.each(
        (null == n ? (e.local ? Sa : Aa) : 'function' == typeof n ? (e.local ? Da : Ta) : e.local ? Ca : ka)(e, n)
      );
    },
    style: function (t, n, e) {
      return arguments.length > 1
        ? this.each((null == n ? za : 'function' == typeof n ? Fa : Ea)(t, n, null == e ? '' : e))
        : (function (t, n) {
    ...
    property: function (t, n) {
      return arguments.length > 1
        ? this.each((null == n ? Ha : 'function' == typeof n ? Ua : La)(t, n))
        : this.node()[t];
    },
    classed: function (t, n) {
      var e = Ra(t + '');
      if (arguments.length < 2) {
        for (var r = Ya(this.node()), i = -1, a = e.length; ++i < a; ) if (!r.contains(e[i])) return !1;
        return !0;
      }
    ...
    text: function (t) {
      return arguments.length
        ? this.each(null == t ? Ba : ('function' == typeof t ? Va : Xa)(t))
        : this.node().textContent;
    },
    html: function (t) {
      return arguments.length
        ? this.each(null == t ? Wa : ('function' == typeof t ? Za : Ga)(t))
        : this.node().innerHTML;
    },
    raise: function () {
      return this.each(Qa);
    ...
    on: function (t, n, e) {
      var r,
        ...
        o = a.length;
      if (!(arguments.length < 2)) {
        for (u = n ? uo : oo, null == e && (e = !1), r = 0; r < o; ++r) this.each(u(a[r], n, e));
        return this;
      }
      var u = this.node().__on;
      if (u)
  ...
  var yo = vo('1f77b4ff7f0e2ca02cd627289467bd8c564be377c27f7f7fbcbd2217becf'),
    ...
    xo = s({
      props: { id: {}, colorScale: { default: An().range(['black', 'white']) }, angle: { default: 0 } },
      init: function (t, n) {
        (n.id = 'areaGradient'.concat(Math.round(1e4 * Math.random()))), (n.gradient = ea(t).append('linearGradient'));
      },
      update: function (t) {
  ...
  function Mo(t) {
    return (
      ...
      (function (t, n) {
        if (!t) return;
        if ('string' == typeof t) return Ao(t, n);
        var e = Object.prototype.toString.call(t).slice(8, -1);
        'Object' === e && t.constructor && (e = t.constructor.name);
        if ('Map' === e || 'Set' === e) return Array.from(t);
        if ('Arguments' === e || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e)) return Ao(t, n);
      })(t) ||
      (function () {
        throw new TypeError(
          'Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.'
  ...
  s({
    props: { id: { default: 'areaGradient'.concat(Math.round(1e4 * Math.random())) } },
    init: function (t, n) {
  ...
  var So = s({
    props: { bbox: { default: { width: null, height: null } }, passes: { default: 3 } },
    init: function (t, n) {
      n.el = t;
    },
    update: function (t) {
  ...
  s({
    ...
    update: function (t) {
      for (
        var n, e, r = t.el.textContent, i = Math.round(((r.length * t.maxWidth) / t.el.getBBox().width) * 1.2);
  ...
  function To(t) {
    ...
    return (
      e >= 0 && 'xmlns' !== (n = t.slice(0, e)) && (t = t.slice(e + 1)),
      Co.hasOwnProperty(n) ? { space: Co[n], local: t } : t
    );
  }
  function Do(t) {
    return function () {
  ...
  function su(t, n) {
    for (var e = uu(t), r = -1, i = n.length; ++r < i; ) e.add(n[r]);
  }
  function cu(t, n) {
    for (var e = uu(t), r = -1, i = n.length; ++r < i; ) e.remove(n[r]);
  }
  function fu(t) {
    return function () {
      su(this, t);
  ...
  Eu.prototype = {
    ...
    merge: function (t) {
      if (!(t instanceof Eu)) throw new Error('invalid merge');
      for (
        var n = this._groups, e = t._groups, r = n.length, i = e.length, a = Math.min(r, i), o = new Array(r), u = 0;
        u < a;
        ++u
    ...
    attr: function (t, n) {
      ...
      return this.each(
        (null == n ? (e.local ? Wo : Vo) : 'function' == typeof n ? (e.local ? Jo : Qo) : e.local ? Zo : Go)(e, n)
      );
    },
    style: function (t, n, e) {
      return arguments.length > 1
        ? this.each((null == n ? tu : 'function' == typeof n ? eu : nu)(t, n, null == e ? '' : e))
        : (function (t, n) {
    ...
    property: function (t, n) {
      return arguments.length > 1
        ? this.each((null == n ? ru : 'function' == typeof n ? au : iu)(t, n))
        : this.node()[t];
    },
    classed: function (t, n) {
      var e = ou(t + '');
      if (arguments.length < 2) {
        for (var r = uu(this.node()), i = -1, a = e.length; ++i < a; ) if (!r.contains(e[i])) return !1;
        return !0;
      }
    ...
    text: function (t) {
      return arguments.length
        ? this.each(null == t ? gu : ('function' == typeof t ? mu : du)(t))
        : this.node().textContent;
    },
    html: function (t) {
      return arguments.length
        ? this.each(null == t ? vu : ('function' == typeof t ? bu : yu)(t))
        : this.node().innerHTML;
    },
    raise: function () {
      return this.each(wu);
    ...
    on: function (t, n, e) {
      var r,
        ...
        o = a.length;
      if (!(arguments.length < 2)) {
        for (u = n ? Cu : ku, r = 0; r < o; ++r) this.each(u(a[r], n, e));
        return this;
      }
      var u = this.node().__on;
      if (u)
  ...
  var Lu = /^\s+/,
    Uu = /\s+$/;
  function Ru(t, n) {
    if (((n = n || {}), (t = t || '') instanceof Ru)) return t;
    if (!(this instanceof Ru)) return new Ru(t, n);
    var e = (function (t) {
      var n = { r: 0, g: 0, b: 0 },
        e = 1,
        r = null,
      ...
      'string' == typeof t &&
        (t = (function (t) {
          ...
          if ((n = pl.rgb.exec(t))) return { r: n[1], g: n[2], b: n[3] };
          if ((n = pl.rgba.exec(t))) return { r: n[1], g: n[2], b: n[3], a: n[4] };
          if ((n = pl.hsl.exec(t))) return { h: n[1], s: n[2], l: n[3] };
          if ((n = pl.hsla.exec(t))) return { h: n[1], s: n[2], l: n[3], a: n[4] };
          if ((n = pl.hsv.exec(t))) return { h: n[1], s: n[2], v: n[3] };
          if ((n = pl.hsva.exec(t))) return { h: n[1], s: n[2], v: n[3], a: n[4] };
          if ((n = pl.hex8.exec(t)))
            return { r: al(n[1]), g: al(n[2]), b: al(n[3]), a: sl(n[4]), format: e ? 'name' : 'hex8' };
          if ((n = pl.hex6.exec(t))) return { r: al(n[1]), g: al(n[2]), b: al(n[3]), format: e ? 'name' : 'hex' };
          if ((n = pl.hex4.exec(t)))
            return {
              r: al(n[1] + '' + n[1]),
              g: al(n[2] + '' + n[2]),
      ...
      'object' == Hu(t) &&
        (gl(t.r) && gl(t.g) && gl(t.b)
          ? ((l = t.r),
            (s = t.g),
            (c = t.b),
            (n = { r: 255 * rl(l, 255), g: 255 * rl(s, 255), b: 255 * rl(c, 255) }),
            (o = !0),
            (u = '%' === String(t.r).substr(-1) ? 'prgb' : 'rgb'))
          : gl(t.h) && gl(t.s) && gl(t.v)
          ? ((r = ul(t.s)),
            (i = ul(t.v)),
            (n = (function (t, n, e) {
              (t = 6 * rl(t, 360)), (n = rl(n, 100)), (e = rl(e, 100));
              var r = Math.floor(t),
                i = t - r,
                a = e * (1 - n),
                o = e * (1 - i * n),
                ...
                c = [u, e, e, o, a, a][l],
                f = [a, a, u, e, e, o][l];
              return { r: 255 * s, g: 255 * c, b: 255 * f };
            })(t.h, r, i)),
            (o = !0),
            (u = 'hsv'))
          : gl(t.h) &&
            ...
            (n = (function (t, n, e) {
              ...
              function o(t, n, e) {
                return (
                  e < 0 && (e += 1),
                  e > 1 && (e -= 1),
                  e < 1 / 6 ? t + 6 * (n - t) * e : e < 0.5 ? n : e < 2 / 3 ? t + (n - t) * (2 / 3 - e) * 6 : t
                );
              }
              if (((t = rl(t, 360)), (n = rl(n, 100)), (e = rl(e, 100)), 0 === n)) r = i = a = e;
              else {
  ...
  function Yu(t, n, e) {
    (t = rl(t, 255)), (n = rl(n, 255)), (e = rl(e, 255));
    var r,
      i,
      a = Math.max(t, n, e),
      o = Math.min(t, n, e),
    ...
    if (a == o) r = i = 0;
      ...
      var l = a - o;
      switch (((i = u > 0.5 ? l / (2 - a - o) : l / (a + o)), a)) {
        case t:
          r = (n - e) / l + (n < e ? 6 : 0);
          break;
        case n:
  ...
  function ju(t, n, e, r) {
    return [
      ol(ll(r)),
      ol(Math.round(t).toString(16)),
      ol(Math.round(n).toString(16)),
      ol(Math.round(e).toString(16)),
    ].join('');
  }
  function $u(t, n) {
    n = 0 === n ? 0 : n || 10;
  ...
  function Zu(t, n) {
    ...
    for (var e = Ru(t).toHsl(), r = [Ru(t)], i = 360 / n, a = 1; a < n; a++)
      r.push(Ru({ h: (e.h + a * i) % 360, s: e.s, l: e.l }));
    return r;
  }
  function Qu(t) {
    var n = Ru(t).toHsl(),
      e = n.h;
    return [Ru(t), Ru({ h: (e + 72) % 360, s: n.s, l: n.l }), Ru({ h: (e + 216) % 360, s: n.s, l: n.l })];
  }
  function Ju(t, n, e) {
    (n = n || 6), (e = e || 30);
    var r = Ru(t).toHsl(),
      i = 360 / e,
      a = [Ru(t)];
    for (r.h = (r.h - ((i * n) >> 1) + 720) % 360; --n; ) (r.h = (r.h + i) % 360), a.push(Ru(r));
    return a;
  }
  function Ku(t, n) {
    n = n || 6;
    for (var e = Ru(t).toHsv(), r = e.h, i = e.s, a = e.v, o = [], u = 1 / n; n--; )
      o.push(Ru({ h: r, s: i, v: a })), (a = (a + u) % 1);
    return o;
  }
  (Ru.prototype = {
    isDark: function () {
    ...
    toPercentageRgbString: function () {
      return 1 == this._a
        ? 'rgb(' +
            Math.round(100 * rl(this._r, 255)) +
            '%, ' +
            Math.round(100 * rl(this._g, 255)) +
            '%, ' +
            Math.round(100 * rl(this._b, 255)) +
            '%)'
        : 'rgba(' +
            Math.round(100 * rl(this._r, 255)) +
            '%, ' +
    ...
    toString: function (t) {
      ...
      return n || !r || ('hex' !== t && 'hex6' !== t && 'hex3' !== t && 'hex4' !== t && 'hex8' !== t && 'name' !== t)
    ...
    (Ru.fromRatio = function (t, n) {
      if ('object' == Hu(t)) {
        var e = {};
        for (var r in t) t.hasOwnProperty(r) && (e[r] = 'a' === r ? t[r] : ul(t[r]));
        t = e;
      }
      return Ru(t, n);
    }),
    ...
    (Ru.random = function () {
      return Ru.fromRatio({ r: Math.random(), g: Math.random(), b: Math.random() });
    }),
    ...
    (Ru.readability = function (t, n) {
      var e = Ru(t),
        r = Ru(n);
      return (
        (Math.max(e.getLuminance(), r.getLuminance()) + 0.05) / (Math.min(e.getLuminance(), r.getLuminance()) + 0.05)
      );
    }),
    ...
    (Ru.mostReadable = function (t, n, e) {
      ...
      for (var s = 0; s < n.length; s++) (r = Ru.readability(t, n[s])) > l && ((l = r), (u = Ru(n[s])));
      return Ru.isReadable(t, u, { level: a, size: o }) || !i
        ? u
        : ((e.includeFallbackColors = !1), Ru.mostReadable(t, ['#fff', '#000'], e));
    });
  var tl = (Ru.names = {
      aliceblue: 'f0f8ff',
      antiquewhite: 'faebd7',
      ...
      update: function (t) {
        t.gradient.colorScale(t.scale),
          ...
          t.unitLabel
            ...
            .style(
              'fill',
              Ru(t.scale((t.scale.domain()[t.scale.domain().length - 1] - t.scale.domain()[0]) / 2)).isLight()
                ? '#444'
                : '#CCC'
            ),
          ...
          t.startLabel
            ...
            .attr('x', 0.02 * t.width)
            .attr('y', 0.5 * t.height)
            .style('fill', Ru(t.scale(t.scale.domain()[0])).isLight() ? '#444' : '#CCC'),
          t.startLabelFitText.bbox({ width: 0.3 * t.width, height: 0.7 * t.height }),
          t.endLabel
            .text(t.scale.domain()[t.scale.domain().length - 1])
            .attr('x', 0.98 * t.width)
            .attr('y', 0.5 * t.height)
            .style('fill', Ru(t.scale(t.scale.domain()[t.scale.domain().length - 1])).isLight() ? '#444' : '#CCC'),
          t.endLabelFitText.bbox({ width: 0.3 * t.width, height: 0.7 * t.height });
      },
    }),
    ml = s({
      props: { width: {}, height: {}, scale: {}, label: {} },
      ...
      update: function (t) {
        ...
        r.append('rect').attr('y', 0).attr('rx', 0).attr('ry', 0).attr('stroke-width', 0),
          ...
          e
            ...
            .each(function (e) {
              So().bbox({ width: 0.9 * n, height: 0.8 * t.height })(this);
            }),
  ...
  wl.prototype = bl.prototype = {
    ...
    on: function (t, n) {
      ...
      if (!(arguments.length < 2)) {
        ...
        for (; ++o < u; )
          if ((e = (t = a[o]).type)) i[e] = xl(i[e], t.name, n);
          else if (null == n) for (e in i) i[e] = xl(i[e], t.name, null);
        return this;
      }
      for (; ++o < u; ) if ((e = (t = a[o]).type) && (e = _l(i[e], t.name))) return e;
    },
    copy: function () {
      var t = {},
        n = this._;
  ...
  function Pl() {
    (El = (zl = Hl.now()) + Fl), (Cl = Tl = 0);
    try {
      !(function () {
        Ul(), ++Cl;
        for (var t, n = Sl; n; ) (t = El - n._time) >= 0 && n._call.call(void 0, t), (n = n._next);
        --Cl;
      })();
    } finally {
      (Cl = 0),
        (function () {
          ...
          for (; e; )
            e._call
              ...
              : ((n = e._next), (e._next = null), (e = t ? (t._next = n) : (Sl = n)));
          (kl = t), $l(r);
        })(),
        (El = 0);
    }
  ...
  function $l(t) {
    Cl ||
      ...
      t - El > 24
        ? (t < 1 / 0 && (Tl = setTimeout(Pl, t - Hl.now() - Fl)), Dl && (Dl = clearInterval(Dl)))
        : (Dl || ((zl = Hl.now()), (Dl = setInterval(jl, Nl))), (Cl = 1), Ll(Pl)));
  }
  function Il(t, n, e) {
    var r = new Yl();
    return (
  ...
  function Kl(t, n, e, r, i, a) {
    ...
    !(function (t, n, e) {
      var r,
        i = t.__transition;
      function a(t) {
        (e.state = Vl), e.timer.restart(o, e.delay, e.time), e.delay <= t && o(t - e.delay);
      }
      function o(a) {
        var s, c, f, h;
        if (e.state !== Vl) return l();
        for (s in i)
          if ((h = i[s]).name === e.name) {
            if (h.state === Gl) return Il(o);
            h.state === Zl
              ? ((h.state = Jl), h.timer.stop(), h.on.call('interrupt', t, t.__data__, h.index, h.group), delete i[s])
              : +s < n &&
                ((h.state = Jl), h.timer.stop(), h.on.call('cancel', t, t.__data__, h.index, h.group), delete i[s]);
          }
        if (
          (Il(function () {
      ...
      function u(n) {
        for (
          var i = n < e.duration ? e.ease.call(null, n / e.duration) : (e.timer.restart(l), (e.state = Ql), 1),
            a = -1,
            o = r.length;
          ++a < o;
      ...
      function l() {
        for (var r in ((e.state = Jl), e.timer.stop(), delete i[n], i)) return;
        delete t.__transition;
      }
      (i[n] = e), (e.timer = Ol(a, 0, e.time));
    })(t, e, {
      name: n,
      index: r,
      group: i,
  ...
  function ts(t, n) {
    var e = es(t, n);
    if (e.state > Xl) throw new Error('too late; already scheduled');
    return e;
  }
  function ns(t, n) {
    var e = es(t, n);
    if (e.state > Gl) throw new Error('too late; already running');
    return e;
  }
  function es(t, n) {
  ...
  Ms.prototype = {
      ...
      for (var r = this._groups, i = r.length, a = new Array(i), o = 0; o < i; ++o)
        for (var u, l, s = r[o], c = s.length, f = (a[o] = new Array(c)), h = 0; h < c; ++h)
          (u = s[h]) &&
            ...
            ('__data__' in u && (l.__data__ = u.__data__), (f[h] = l), Kl(f[h], n, e, h, f, es(u, e)));
    ...
    transition: function () {
      for (var t = this._name, n = this._id, e = As(), r = this._groups, i = r.length, a = 0; a < i; ++a)
        for (var o, u = r[a], l = u.length, s = 0; s < l; ++s)
          if ((o = u[s])) {
            var c = es(o, n);
            Kl(o, t, e, s, u, { time: c.time + c.delay + c.duration, delay: 0, duration: c.duration, ease: c.ease });
          }
    ...
    attr: function (t, n) {
      ...
      return this.attrTween(
        t,
        'function' == typeof n
          ? (e.local ? ps : hs)(e, r, os(this, 'attr.' + t, n))
          : null == n
          ? (e.local ? ss : ls)(e)
          : (e.local ? fs : cs)(e, r, n)
      );
            ...
            (function (t, n, e) {
              ...
              return function () {
                var o = Ai(this, t),
                  ...
                  l = u + '';
                return (
                  null == u && (this.style.removeProperty(t), (l = u = Ai(this, t))),
                  o === l ? null : o === r && l === i ? a : ((i = l), (a = n((r = o), u)))
                );
              };
            })(t, r, os(this, 'style.' + t, n))
          ).each(
            (function (t, n) {
              var e,
                r,
  ...
  (na.prototype.interrupt = function (t) {
    ...
    (na.prototype.transition = function (t) {
      ...
      t instanceof Ms
        ? ((n = t._id), (t = t._name))
        : ((n = As()), ((e = ks).time = Ul()), (t = null == t ? null : t + ''));
      for (var r = this._groups, i = r.length, a = 0; a < i; ++a)
        for (var o, u = r[a], l = u.length, s = 0; s < l; ++s) (o = u[s]) && Kl(o, t, n, s, u, e || Cs(o, n));
  ...
  var Ps = {
    ...
    Is = { e: 'w', w: 'e', nw: 'ne', ne: 'nw', se: 'sw', sw: 'se' },
    qs = { n: 's', s: 'n', nw: 'sw', ne: 'se', se: 'ne', sw: 'nw' },
    Bs = { overlay: 1, selection: 1, n: null, e: 1, s: null, w: -1, nw: -1, ne: 1, se: 1, sw: -1 },
    Xs = { overlay: 1, selection: 1, n: -1, e: null, s: 1, w: null, nw: -1, ne: -1, se: 1, sw: 1 };
  function Vs(t) {
    return { type: t };
  }
  function Ws(t) {
      ...
      function h(e) {
        if ((!n || e.touches) && r.apply(this, arguments)) {
          ...
          if ('overlay' === b) {
            ...
            (M.selection = S =
              [
                [(i = t === js ? k : Rs(n[0][0], n[1][0])), (u = t === Ps ? C : Rs(n[0][1], n[1][1]))],
                [(f = t === js ? T : Us(n[0][0], n[1][0])), (p = t === Ps ? D : Us(n[0][1], n[1][1]))],
              ]),
              F.length > 1 && O(e);
          } else (i = S[0][0]), (u = S[0][1]), (f = S[1][0]), (p = S[1][1]);
          (o = i), (l = u), (h = f), (g = p);
          var L = ea(y).attr('pointer-events', 'none'),
            U = L.selectAll('.overlay').attr('cursor', $s[b]);
          if (e.touches) (H.moved = Y), (H.ended = P);
          else {
            ...
            a && R.on('keydown.brush', j, !0).on('keyup.brush', $, !0),
              (function (t) {
                ...
                'onselectstart' in n
                  ? e.on('selectstart.drag', Al, Ml)
                  : ((n.__noselect = n.style.MozUserSelect), (n.style.MozUserSelect = 'none'));
              })(e.view);
          }
          s.call(y), H.start(e, w.name);
        }
        function Y(t) {
          for (const n of t.changedTouches || [t])
            for (const t of F) t.identifier === n.identifier && (t.cur = ra(n, y));
          if (E && !m && !v && 1 === F.length) {
            const t = F[0];
            Ls(t.cur[0] - t[0]) > Ls(t.cur[1] - t[1]) ? (v = !0) : (m = !0);
          }
          for (const t of F) t.cur && ((t[0] = t.cur[0]), (t[1] = t.cur[1]));
          (d = !0), Ns(t), O(t);
        }
        function O(t) {
          const n = F[0],
          ...
          switch (((N = n[0] - e[0]), (z = n[1] - e[1]), w)) {
            ...
            case Fs:
              F[1]
                ? (_ && ((o = Us(k, Rs(T, F[0][0]))), (h = Us(k, Rs(T, F[1][0]))), (_ = 1)),
                  x && ((l = Us(C, Rs(D, F[0][1]))), (g = Us(C, Rs(D, F[1][1]))), (x = 1)))
                : (_ < 0
                    ? ((N = Us(k - i, Rs(T - i, N))), (o = i + N), (h = f))
                    : _ > 0 && ((N = Us(k - f, Rs(T - f, N))), (o = i), (h = f + N)),
                  x < 0
                    ? ((z = Us(C - u, Rs(D - u, z))), (l = u + z), (g = p))
                    : x > 0 && ((z = Us(C - p, Rs(D - p, z))), (l = u), (g = p + z)));
              break;
            case Hs:
          ...
          h < o &&
            ...
            m && ((o = S[0][0]), (h = S[1][0])),
            v && ((l = S[0][1]), (g = S[1][1])),
            (S[0][0] === o && S[0][1] === l && S[1][0] === h && S[1][1] === g) ||
              ((M.selection = [
                [o, l],
                [h, g],
              ]),
        ...
        function j(t) {
          switch (t.keyCode) {
            ...
            case 18:
              w === Fs &&
                (_ && ((f = h - N * _), (i = o + N * _)), x && ((p = g - z * x), (u = l + z * x)), (w = Hs), O(t));
              break;
            case 32:
              (w !== Fs && w !== Hs) ||
                (_ < 0 ? (f = h - N) : _ > 0 && (i = o - N),
        ...
        function $(t) {
          switch (t.keyCode) {
            ...
            case 32:
              w === Es &&
                (t.altKey
                  ? (_ && ((f = h - N * _), (i = o + N * _)), x && ((p = g - z * x), (u = l + z * x)), (w = Hs))
                  : (_ < 0 ? (f = h) : _ > 0 && (i = o), x < 0 ? (p = g) : x > 0 && (u = l), (w = Fs)),
                U.attr('cursor', $s[b]),
                O(t));
              break;
            default:
          ...
          n.tween
            ...
            : n.each(function () {
                var n = this,
                  ...
                  u = c(n, i).beforestart();
                rs(n), (a.selection = null === o ? null : o), s.call(n), u.start(r).brush(r).end(r);
              });
        }),
        ...
        (f.prototype = {
          ...
          emit: function (n, e, r) {
            ...
            o.call(
              n,
              this.that,
              new Ds(n, { sourceEvent: e, target: l, selection: t.output(this.state.selection), mode: r, dispatch: o }),
              i
            );
          },
        }),
      ...
      if (!(t.domainRange[1] <= t.domainRange[0])) {
        ...
        t.scale.domain(t.domainRange).range([0, n]),
          ...
          t.svg
            ...
            .attr('transform', 'translate('.concat(t.margins.left, ',').concat(t.margins.top, ')')),
  ...
  return s({
    props: {
      data: {
        ...
        onChange: function (t, n) {
          !(function (t) {
            ...
            (n.zoomX = [
              k(n.completeFlatData, function (t) {
      ...
      zoomX: {
        default: [null, null],
        onChange: function (t, n) {
          n.svg && n.svg.dispatch('zoom', { detail: { zoomX: t, zoomY: null, redraw: !1 } });
        },
      },
      zoomY: {
        default: [null, null],
        onChange: function (t, n) {
          n.svg && n.svg.dispatch('zoom', { detail: { zoomX: null, zoomY: t, redraw: !1 } });
        },
      },
      minSegmentDuration: {},
      zColorScale: { default: Ir(wo) },
      zQualitative: {
        default: !1,
      ...
      zoomYLabels: function (t, n) {
        ...
        function e(n) {
          ...
          return a(
            ...
            t.completeStructData[t.completeStructData.length - 1].lines.length - 1
          );
          function a(t, n) {
      ...
      (n.svg = i.append('svg')),
        ...
        (function () {
          (n.yScale.invert = e),
            (n.grpScale.invert = e),
            (n.groupGradId = xo()
              .colorScale(An().domain([0, 1]).range(n.groupBkgGradient))
              .angle(-90)(n.svg.node())
              .id());
            ...
            n.enableOverview &&
              ((n.overviewArea = Ks()
                ...
                .onChange(function (t, e) {
                  n.svg.dispatch('zoom', { detail: { zoomX: [t, e], zoomY: null } });
                })
                .domainRange(n.zoomX)
              ...
              n.svg.on('zoomScent', function (t) {
                ...
                n.overviewArea &&
                  e &&
                  ((e[0] < n.overviewArea.domainRange()[0] || e[1] > n.overviewArea.domainRange()[1]) &&
        ...
        (n.segmentTooltip = mo()
          ...
          .html(function (t, e) {
            ...
            return (
              ...
              n.zDataLabel +
              (r
                ? ' (<strong>' + Math.round(((e.val - n.zColorScale.domain()[0]) / r) * 100 * 100) / 100 + '%</strong>)'
                : '') +
                    ...
                    n.svg.dispatch('zoomScent', {
                      detail: {
                        ...
                        zoomY: [e[1], o[1]].sort(c).map(function (t) {
                          return (
                            n.yScale.domain().indexOf(n.yScale.invert(t)) + (n.zoomY && n.zoomY[0] ? n.zoomY[0] : 0)
                          );
                        }),
                      },
                    });
                ...
                .on(
                  ...
                  function (t) {
                    ...
                    if (e[0] != o[0] || e[1] != o[1]) {
                      ...
                      (s || f) && n.svg.dispatch('zoom', { detail: { zoomX: s ? u : null, zoomY: f ? l : null } });
                    }
                  },
                  !0
                ),
        ...
        n.svg.on('resetZoom', function () {
          ...
          (t[0] < r[0] || t[1] > r[1] || e[0] != i[0] || e[1] != r[1]) &&
            ((n.zoomX = [new Date(Math.min(t[0], r[0])), new Date(Math.max(t[1], r[1]))]),
            (n.zoomY = i),
            n.svg.dispatch('zoomScent', { detail: { zoomX: n.zoomX, zoomY: n.zoomY } }),
            n._rerender()),
      ...
      !(function () {
        ...
        for (
          var i = function (t) {
              ...
              if (r[0] >= e.length) return (r[0] -= e.length), 'continue';
              var i = { group: n.completeStructData[t].group, lines: null };
              if (e.length - r[0] >= r[1])
        ...
        n.overviewArea &&
          n.overviewArea
            .width(0.8 * n.width)
            .height(n.overviewHeight + n.overviewArea.margins().top + n.overviewArea.margins().bottom),
        (n.zoomX[0] =
          n.zoomX[0] ||
          k(n.flatData, function (t) {
            return t.timeRange[0];
        ...
        (function () {
          for (
            ...
            e(r);
          n.yScale.domain(t), n.yScale.range([(n.graphH / t.length) * 0.5, n.graphH * (1 - 0.5 / t.length)]);
        })(),
        (function () {
          n.grpScale.domain(
        ...
        (function () {
          ...
          n.xAxis.scale(n.xScale).ticks(e).tickFormat(n.xTickFormat),
            ...
            n.svg
              ...
              .duration(n.transDuration)
              .call(n.xGrid),
            n.dateMarker && n.dateMarker >= n.xScale.domain()[0] && n.dateMarker <= n.xScale.domain()[1]
              ? n.dateMarkerLine
                  .style('display', 'block')
                  .transition()
                  .duration(n.transDuration)
          ...
          var r = Math.ceil((n.nLines * n.minLabelFont) / Math.sqrt(2) / n.graphH / 0.6),
          ...
          n.yAxis.tickValues(i),
            n.yAxis.tickFormat(function (t) {
              return n.disableReduceLabels ? t.split('+&+')[1] : l(t.split('+&+')[1], o);
            }),
            n.svg
              .select('g.y-axis')
              .transition()
          ...
          (a = Math.min(14, 0.6 * u * Math.sqrt(2))),
            ...
            n.grpAxis.tickFormat(function (t) {
              return n.disableReduceLabels ? t : l(t, o);
            }),
            n.svg
              .select('g.grp-axis')
              .transition()
        ...
        n.svg
          ...
          .transition()
          .duration(n.transDuration)
          .attr('transform', 'translate('.concat(n.leftMargin + 0.05 * n.graphW, ',2)')),
        n.colorLegend
        ...
        So().bbox({ width: 0.4 * n.graphW, height: Math.min(13, 0.8 * n.topMargin) })(n.resetBtn.node());
    },
  });
});
