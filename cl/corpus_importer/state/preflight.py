...
- `PARTIAL` says the load can go ahead but will not see everything, which is
  what the loader's own query filtering rows out looks like from here.
...
STANDARD_CHECKS: Final[tuple[PreflightCheck, ...]] = (InvalidRows(),)
