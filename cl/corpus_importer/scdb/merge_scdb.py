...
def merge_docs(first_pk, second_pk):
    ...
    first.save()
    first.case_name = second.case_name
...
def enhance_item_with_scdb(doc, scdb_info):
    ...
    doc.federal_cite_one = scdb_info['usCite']
    doc.federal_cite_two = scdb_info['sctCite']
...
def iterate_scdb_and_take_actions(
    ...
    with open(SCDB_FILENAME) as f:
        ...
        for i, d in enumerate(reader):
            ...
            # TODO: EmptyQuerySet cannot be instantiated since Django 1.6.
            docs = EmptyQuerySet()
            if len(docs) == 0:
