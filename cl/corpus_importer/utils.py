...
def winnow_case_name(case_name: str) -> Set:
    ...
    # "In re GOLD & APPEL TRANSFER S.A., Debtor in a Foreign Proceeding. MEADE MALONE, OFFICIAL LIQUIDATOR FOR GOLD & APPEL TRANSFER S.A. v. ICEBERG TRANSPORT S.A." -> "In re GOLD & APPEL TRANSFER SA, Debtor in a Foreign Proceeding. MEADE MALONE, OFFICIAL LIQUIDATOR FOR GOLD & APPEL TRANSFER SA v. ICEBERG TRANSPORT SA"
