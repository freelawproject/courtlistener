...
fd_pairs = (
    ...
    (re.compile('Commerce Court', re.I), 'com'),
    (re.compile('Court of Claims', re.I), 'cc'),
        (re.compile('United States Claims Court', re.I), 'cc'),
    (re.compile('(^|\s)U\. S\. Court of Customs and Patent Appeals', re.I), 'ccpa'),
    (re.compile('(^|\s)(U\. ?S\.)|(United States) Court of International Trade', re.I), 'cit'),
    (re.compile('(^|\s)U\. S\. Customs Court', re.I), 'cusc'),
    (re.compile('(^|\s)U\. S\. District Court for the District of Columbia', re.I), 'dcd'),

    # United States Tax Court
    (re.compile('United States Tax Court', re.I), 'tax'),
    (re.compile('United States Board of Tax Appeals', re.I), 'bta'),

    # this was a special circuit court when california was first founded, it
    # only had one judge
    (re.compile('(^|\s)U\. S\. Circuit Court for the Districts of California', re.I), 'caca'),

    # this was a district court for the territory of orleans
    (re.compile('District of Orleans', re.I), 'orld'),

    # these state district courts have since been split
    (re.compile('District of Alabama', re.I), 'ald'),
    (re.compile('District of Florida', re.I), 'fld'),
    (re.compile('District of Georgia', re.I), 'gad'),
    (re.compile('District of Iowa', re.I), 'iad'),
    (re.compile('District of Kentucky', re.I), 'kyd'),
    (re.compile('District of Louisiana', re.I), 'lad'),
    (re.compile('District of Michigan', re.I), 'michd'),
    (re.compile('District of Mississippi', re.I), 'missd'),
    (re.compile('District of Missouri', re.I), 'mod'),
    (re.compile('District of New York', re.I), 'nyd'),
    (re.compile('District of North Carolina', re.I), 'ncd'),
    (re.compile('District of Texas', re.I), 'texd'),
    (re.compile('District of Virginia', re.I), 'vad'),
    (re.compile('District of Washington', re.I), 'washd'),
    (re.compile('District of West Virginia', re.I), 'wvad'),
    (re.compile('District of Wisconsin', re.I), 'wisd'),
)

ca_pairs = (
    (re.compile('Supreme Court of the United States', re.I), 'scotus'),

    (re.compile('(^|\s)((U\. ?S\.)|(United States)) ((Circuit Courts?)|(Court of Appeals)) for the First Circuit', re.I), 'ca1'),
    (re.compile('(^|\s)((U\. ?S\.)|(United States)) ((Circuit Courts?)|(Court of Appeals)) for the Second Circuit', re.I), 'ca2'),
    (re.compile('(^|\s)((U\. ?S\.)|(United States)) ((Circuit Courts?)|(Court of Appeals)) for the Third Circuit', re.I), 'ca3'),
    (re.compile('(^|\s)((U\. ?S\.)|(United States)) ((Circuit Courts?)|(Court of Appeals)) for the Fourth Circuit', re.I), 'ca4'),
    (re.compile('(^|\s)((U\. ?S\.)|(United States)) ((Circuit Courts?)|(Court of Appeals)) for the Fifth Circuit', re.I), 'ca5'),
    (re.compile('(^|\s)((U\. ?S\.)|(United States)) ((Circuit Courts?)|(Court of Appeals)) for the Sixth Circuit', re.I), 'ca6'),
    (re.compile('(^|\s)((U\. ?S\.)|(United States)) ((Circuit Courts?)|(Court of Appeals)) for the Seventh Circuit', re.I), 'ca7'),
    (re.compile('(^|\s)((U\. ?S\.)|(United States)) ((Circuit Courts?)|(Court of Appeals)) for the Eighth Circuit', re.I), 'ca8'),
    (re.compile('(^|\s)((U\. ?S\.)|(United States)) ((Circuit Courts?)|(Court of Appeals)) for the Ninth Circuit', re.I), 'ca9'),
    (re.compile('(^|\s)((U\. ?S\.)|(United States)) ((Circuit Courts?)|(Court of Appeals)) for the Tenth Circuit', re.I), 'ca10'),
    (re.compile('(^|\s)((U\. ?S\.)|(United States)) ((Circuit Courts?)|(Court of Appeals)) for the Eleventh Circuit', re.I), 'ca11'),
    (re.compile('(^|\s)((U\. ?S\.)|(United States)) Court of Appeals for the District of Columbia Circuit', re.I), 'cadc'),
    (re.compile('(^|\s)((U\. ?S\.)|(United States)) Court of Appeals for the Federal Circuit', re.I), 'cafc'),
)
