...
fd_pairs = (
    ...
    (re.compile(u'District of Alabama', re.I), ''),
    (re.compile(u'District of Florida', re.I), ''),
    (re.compile(u'District of Georgia', re.I), ''),
    (re.compile(u'District of Iowa', re.I), ''),
    (re.compile(u'District of Kentucky', re.I), ''),
    (re.compile(u'District of Louisiana', re.I), ''),
    (re.compile(u'District of Michigan', re.I), ''),
    (re.compile(u'District of Mississippi', re.I), ''),
    (re.compile(u'District of Missouri', re.I), ''),
    (re.compile(u'District of New York', re.I), ''),
    (re.compile(u'District of North Carolina', re.I), ''),    
    (re.compile(u'District of Texas', re.I), ''),
    (re.compile(u'District of Virginia', re.I), ''),
    (re.compile(u'District of Washington', re.I), ''),
    (re.compile(u'District of West Virginia', re.I), ''),
    (re.compile(u'District of Wisconsin', re.I), ''),
