...
class ParentheticalDocument(Document):
    describing_opinion_url = fields.KeywordField(attr="describing_opinion.get_absolute_url")
    ...
    describing_opinion_cluster_docket_number = fields.TextField(
    ...
    described_opinion_cluster_docket_number = fields.TextField(
