...
--
-- Add field docket_number_raw to originatingcourtinformationevent
--
ALTER TABLE "search_originatingcourtinformationevent" ADD COLUMN "docket_number_raw" varchar DEFAULT '' NOT NULL;
ALTER TABLE "search_originatingcourtinformationevent" ALTER COLUMN "docket_number_raw" DROP DEFAULT;
