...
--
CREATE TABLE "search_courthouse" ("id" integer NOT NULL PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY, "court_seat" boolean NULL, "building_name" text NOT NULL, "address1" text NOT NULL, "address2" text NOT NULL, "city" text NOT NULL, "county" text NOT NULL, "state" varchar(2) NOT NULL, "zip_code" varchar(10) NOT NULL, "country_code" varchar(2) NOT NULL);
--
