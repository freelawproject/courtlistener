...
--
CREATE TABLE "search_courthouse" ("id" integer NOT NULL PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY, "court_seat" boolean NULL, "building_name" varchar(255) NULL, "address_line_1" varchar(255) NULL, "address_line_2" varchar(255) NULL, "city" varchar(255) NULL, "county" varchar(255) NULL, "state" varchar(2) NULL, "country" varchar(2) NOT NULL, "zip_code" varchar(10) NULL);
--
