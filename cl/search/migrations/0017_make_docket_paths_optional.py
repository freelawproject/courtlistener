...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='recapdocument',
            name='filepath_local',
            field=models.FileField(help_text='The path of the file in the local storage area.', max_length=1000, upload_to=cl.lib.model_helpers.make_recap_path, blank=True),
        ),
    ]
