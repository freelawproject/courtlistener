...
--
-- Add field acms_document_guid to claimhistoryevent
--
ALTER TABLE "search_claimhistoryevent" ADD COLUMN "acms_document_guid" varchar(64) DEFAULT '' NOT NULL;
ALTER TABLE "search_claimhistoryevent" ALTER COLUMN "acms_document_guid" DROP DEFAULT;
--
