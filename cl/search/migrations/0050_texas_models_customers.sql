...
--
CREATE TABLE "search_texasdocketentry" ("id" integer NOT NULL PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY, "date_created" timestamp with time zone NOT NULL, "date_modified" timestamp with time zone NOT NULL, "appellate_brief" boolean NOT NULL, "description" text NOT NULL, "remarks" text NOT NULL, "date_filed" date NULL, "entry_type" text NOT NULL, "sequence_number" varchar(16) NOT NULL, "docket_id" integer NOT NULL);
