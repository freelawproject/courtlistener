...
--
-- Add field xml_scan to opinion
--
ALTER TABLE "search_opinion" ADD COLUMN "xml_scan" text DEFAULT '' NOT NULL;
ALTER TABLE "search_opinion" ALTER COLUMN "xml_scan" DROP DEFAULT;
--
...
--
-- Add field xml_scan to opinionevent
--
ALTER TABLE "search_opinionevent" ADD COLUMN "xml_scan" text DEFAULT '' NOT NULL;
ALTER TABLE "search_opinionevent" ALTER COLUMN "xml_scan" DROP DEFAULT;
--
...
--
-- Create index search_opin_sha1_829052_idx on field(s) sha1 of model opinioncontent
--
CREATE INDEX "search_opin_sha1_829052_idx" ON "search_opinioncontent" ("sha1");
COMMIT;
