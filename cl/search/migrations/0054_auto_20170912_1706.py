    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='The name of the tag.', unique=True, max_length=50, db_index=True)),
            ],
        ),
        migrations.AddField(
            model_name='recapdocument',
            name='tags',
            field=models.ManyToManyField(help_text='The tags associated with the document.', related_name='recap_documents', to='search.Tag', blank=True),
        ),
    ]
