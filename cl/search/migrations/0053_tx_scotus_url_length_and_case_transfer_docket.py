...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(blank=True, db_comment='The docket object in the destination court.', help_text='The docket object in the destination court.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='case_transfer_destination_docket', to='search.docket'),
        ),
        migrations.AlterField(
            model_name='casetransfer',
            name='origin_docket',
            field=models.ForeignKey(blank=True, db_comment='The docket object this transfer originates from.', help_text='The docket object this transfer originates from.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='case_transfer_origin_docket', to='search.docket'),
        ),
        migrations.AlterField(
            model_name='casetransferevent',
            name='destination_docket',
            field=models.ForeignKey(blank=True, db_comment='The docket object in the destination court.', db_constraint=False, help_text='The docket object in the destination court.', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='search.docket'),
        ),
        migrations.AlterField(
            model_name='casetransferevent',
            name='origin_docket',
            field=models.ForeignKey(blank=True, db_comment='The docket object this transfer originates from.', db_constraint=False, help_text='The docket object this transfer originates from.', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='search.docket'),
        ),
        migrations.AlterField(
