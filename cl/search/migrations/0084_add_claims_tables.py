    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filepath_local', models.FileField(blank=True, db_index=True, help_text=b'The path of the file in the local storage area.', max_length=1000, storage=cl.lib.storage.IncrementingFileSystemStorage(), upload_to=cl.lib.model_helpers.make_recap_pdf_path)),
                ...
                ('thumbnail', models.FileField(blank=True, help_text=b'A thumbnail of the first page of the document', null=True, storage=cl.lib.storage.IncrementingFileSystemStorage(), upload_to=cl.lib.model_helpers.make_recap_thumb_path)),
