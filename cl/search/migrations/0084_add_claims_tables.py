    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_available', models.BooleanField(default=False, help_text='True if the item is available in RECAP', null=True, blank=True)),
                ...
                ('is_sealed', models.BooleanField(db_index=True, help_text='Is this item sealed or otherwise unavailable on PACER?', null=True)),
