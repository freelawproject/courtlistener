...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.CharField(help_text='Path to the docket JSON page in the Internet Archive', max_length=1000, blank=True),
        ),
        migrations.AddField(
            model_name='docket',
            name='ia_date_first_change',
            field=models.DateTimeField(help_text='The moment when this item first changed and was marked as needing an upload. Used for determining when to upload an item.', null=True, db_index=True),
        ),
        migrations.AddField(
            model_name='docket',
