    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pacer_doc_id', models.CharField(help_text=b'The ID of the document in PACER. This information is provided by RECAP.', max_length=32, blank=True)),
        ...
        migrations.AddField(
            model_name='docket',
            name='cause',
            field=models.CharField(help_text=b'The cause for the case.', max_length=200, blank=True),
        ),
        migrations.AddField(
            model_name='docket',
            name='date_filed',
        ...
        migrations.AddField(
            model_name='docket',
            name='filepath_local',
            field=models.FileField(upload_to=cl.lib.model_helpers.make_recap_path, storage=cl.lib.storage.IncrementingFileSystemStorage(), max_length=1000, blank=True, help_text=b'Path to RECAP\xe2\x80\x99s Docket XML page.', null=True),
        ),
        migrations.AddField(
            model_name='docket',
            name='jurisdiction_type',
            field=models.CharField(help_text=b"Stands for jurisdiction in RECAP XML docket. For example, 'Diversity', 'U.S. Government Defendant'.", max_length=100, blank=True),
        ),
        migrations.AddField(
            model_name='docket',
            name='jury_demand',
            field=models.CharField(help_text=b'The compensation demand.', max_length=500, blank=True),
        ),
        migrations.AddField(
            model_name='docket',
            name='nature_of_suit',
            field=models.CharField(help_text=b'The nature of suit code from PACER.', max_length=100, blank=True),
        ),
        migrations.AddField(
            model_name='docket',
            name='pacer_case_id',
