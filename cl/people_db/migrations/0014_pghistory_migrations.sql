...
--
CREATE TABLE "people_db_educationevent" ("pgh_id" serial NOT NULL PRIMARY KEY, "pgh_created_at" timestamp with time zone NOT NULL, "pgh_label" text NOT NULL, "id" integer NOT NULL, "date_created" timestamp with time zone NOT NULL, "date_modified" timestamp with time zone NOT NULL, "degree_level" varchar(4) NOT NULL, "degree_detail" varchar(100) NOT NULL, "degree_year" smallint NULL CHECK ("degree_year" >= 0));
--
-- Create model PartiesEvent
--
CREATE TABLE "people_db_partiesevent" ("pgh_id" serial NOT NULL PRIMARY KEY, "pgh_created_at" timestamp with time zone NOT NULL, "pgh_label" text NOT NULL, "id" integer NOT NULL, "name" varchar(100) NOT NULL, "date_terminated" date NULL, "extra_info" text NOT NULL, "highest_offense_level_opening" text NOT NULL, "highest_offense_level_terminated" text NOT NULL);
--
-- Create model PersonEvent
--
CREATE TABLE "people_db_personevent" ("pgh_id" serial NOT NULL PRIMARY KEY, "pgh_created_at" timestamp with time zone NOT NULL, "pgh_label" text NOT NULL, "id" integer NOT NULL, "date_created" timestamp with time zone NOT NULL, "date_modified" timestamp with time zone NOT NULL, "date_completed" timestamp with time zone NULL, "fjc_id" integer NULL, "slug" varchar(158) NOT NULL, "name_first" varchar(50) NOT NULL, "name_middle" varchar(50) NOT NULL, "name_last" varchar(50) NOT NULL, "name_suffix" varchar(5) NOT NULL, "date_dob" date NULL, "date_granularity_dob" varchar(15) NOT NULL, "date_dod" date NULL, "date_granularity_dod" varchar(15) NOT NULL, "dob_city" varchar(50) NOT NULL, "dob_state" varchar(2) NOT NULL, "dob_country" varchar(50) NOT NULL, "dod_city" varchar(50) NOT NULL, "dod_state" varchar(2) NOT NULL, "dod_country" varchar(50) NOT NULL, "gender" varchar(2) NOT NULL, "religion" varchar(30) NOT NULL, "ftm_total_received" double precision NULL, "ftm_eid" varchar(30) NULL, "has_photo" boolean NOT NULL);
--
-- Create model PersonRaceEvent
--
CREATE TABLE "people_db_personraceevent" ("pgh_id" serial NOT NULL PRIMARY KEY, "pgh_created_at" timestamp with time zone NOT NULL, "pgh_label" text NOT NULL, "id" integer NOT NULL);
--
-- Create model PoliticalAffiliationEvent
--
CREATE TABLE "people_db_politicalaffiliationevent" ("pgh_id" serial NOT NULL PRIMARY KEY, "pgh_created_at" timestamp with time zone NOT NULL, "pgh_label" text NOT NULL, "id" integer NOT NULL, "date_created" timestamp with time zone NOT NULL, "date_modified" timestamp with time zone NOT NULL, "political_party" varchar(5) NOT NULL, "source" varchar(5) NOT NULL, "date_start" date NULL, "date_granularity_start" varchar(15) NOT NULL, "date_end" date NULL, "date_granularity_end" varchar(15) NOT NULL);
--
-- Create model PositionEvent
--
CREATE TABLE "people_db_positionevent" ("pgh_id" serial NOT NULL PRIMARY KEY, "pgh_created_at" timestamp with time zone NOT NULL, "pgh_label" text NOT NULL, "id" integer NOT NULL, "date_created" timestamp with time zone NOT NULL, "date_modified" timestamp with time zone NOT NULL, "position_type" varchar(20) NULL, "job_title" varchar(100) NOT NULL, "sector" smallint NULL, "organization_name" varchar(120) NULL, "location_city" varchar(50) NOT NULL, "location_state" varchar(2) NOT NULL, "date_nominated" date NULL, "date_elected" date NULL, "date_recess_appointment" date NULL, "date_referred_to_judicial_committee" date NULL, "date_judicial_committee_action" date NULL, "judicial_committee_action" varchar(20) NOT NULL, "date_hearing" date NULL, "date_confirmation" date NULL, "date_start" date NULL, "date_granularity_start" varchar(15) NOT NULL, "date_termination" date NULL, "termination_reason" varchar(25) NOT NULL, "date_granularity_termination" varchar(15) NOT NULL, "date_retirement" date NULL, "nomination_process" varchar(20) NOT NULL, "vote_type" varchar(2) NOT NULL, "voice_vote" boolean NULL, "votes_yes" integer NULL CHECK ("votes_yes" >= 0), "votes_no" integer NULL CHECK ("votes_no" >= 0), "votes_yes_percent" double precision NULL, "votes_no_percent" double precision NULL, "how_selected" varchar(20) NOT NULL, "has_inferred_values" boolean NOT NULL);
--
-- Create model RaceEvent
--
CREATE TABLE "people_db_raceevent" ("pgh_id" serial NOT NULL PRIMARY KEY, "pgh_created_at" timestamp with time zone NOT NULL, "pgh_label" text NOT NULL, "id" integer NOT NULL, "race" varchar(5) NOT NULL);
--
-- Create model RetentionEventEvent
--
CREATE TABLE "people_db_retentioneventevent" ("pgh_id" serial NOT NULL PRIMARY KEY, "pgh_created_at" timestamp with time zone NOT NULL, "pgh_label" text NOT NULL, "id" integer NOT NULL, "date_created" timestamp with time zone NOT NULL, "date_modified" timestamp with time zone NOT NULL, "retention_type" varchar(10) NOT NULL, "date_retention" date NOT NULL, "votes_yes" integer NULL CHECK ("votes_yes" >= 0), "votes_no" integer NULL CHECK ("votes_no" >= 0), "votes_yes_percent" double precision NULL, "votes_no_percent" double precision NULL, "unopposed" boolean NULL, "won" boolean NULL);
--
-- Create model SchoolEvent
--
CREATE TABLE "people_db_schoolevent" ("pgh_id" serial NOT NULL PRIMARY KEY, "pgh_created_at" timestamp with time zone NOT NULL, "pgh_label" text NOT NULL, "id" integer NOT NULL, "date_created" timestamp with time zone NOT NULL, "date_modified" timestamp with time zone NOT NULL, "name" varchar(120) NOT NULL, "ein" integer NULL);
--
-- Create model SourceEvent
--
CREATE TABLE "people_db_sourceevent" ("pgh_id" serial NOT NULL PRIMARY KEY, "pgh_created_at" timestamp with time zone NOT NULL, "pgh_label" text NOT NULL, "id" integer NOT NULL, "date_created" timestamp with time zone NOT NULL, "date_modified" timestamp with time zone NOT NULL, "url" varchar(2000) NOT NULL, "date_accessed" date NULL, "notes" text NOT NULL);
--
...
--
            ...
            CREATE  TRIGGER pgtrigger_snapshot_insert_3f5b7
                AFTER INSERT ON "people_db_education"
...
--
            ...
            CREATE  TRIGGER pgtrigger_snapshot_insert_ab32e
                AFTER INSERT ON "people_db_politicalaffiliation"
...
--
            ...
            CREATE  TRIGGER pgtrigger_snapshot_insert_b594d
                AFTER INSERT ON "people_db_position"
            ...
            RETURNS TRIGGER AS $$
                ...
                BEGIN
                    IF ("public"._pgtrigger_should_ignore(TG_NAME) IS TRUE) THEN
                        ...
                        END IF;
                    END IF;
                    INSERT INTO "people_db_raceevent" ("id", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "race") VALUES (NEW."id", _pgh_attach_context(), NOW(), 'snapshot', NEW."id", NEW."race"); RETURN NULL;
                END;
            $$ LANGUAGE plpgsql;

            DROP TRIGGER IF EXISTS pgtrigger_snapshot_insert_36b13 ON "people_db_race";
            CREATE  TRIGGER pgtrigger_snapshot_insert_36b13
                AFTER INSERT ON "people_db_race"
...
--
            ...
            CREATE  TRIGGER pgtrigger_snapshot_update_901ca
                AFTER UPDATE ON "people_db_race"
...
--
            ...
            RETURNS TRIGGER AS $$
                ...
                BEGIN
                    IF ("public"._pgtrigger_should_ignore(TG_NAME) IS TRUE) THEN
                        ...
                        END IF;
                    END IF;
                    INSERT INTO "people_db_retentioneventevent" ("date_created", "date_modified", "date_retention", "id", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "position_id", "retention_type", "unopposed", "votes_no", "votes_no_percent", "votes_yes", "votes_yes_percent", "won") VALUES (NEW."date_created", NEW."date_modified", NEW."date_retention", NEW."id", _pgh_attach_context(), NOW(), 'snapshot', NEW."id", NEW."position_id", NEW."retention_type", NEW."unopposed", NEW."votes_no", NEW."votes_no_percent", NEW."votes_yes", NEW."votes_yes_percent", NEW."won"); RETURN NULL;
                END;
            $$ LANGUAGE plpgsql;
            ...
            CREATE  TRIGGER pgtrigger_snapshot_insert_123d1
                AFTER INSERT ON "people_db_retentionevent"
            ...
            RETURNS TRIGGER AS $$
                ...
                BEGIN
                    IF ("public"._pgtrigger_should_ignore(TG_NAME) IS TRUE) THEN
                        ...
                        END IF;
                    END IF;
                    INSERT INTO "people_db_schoolevent" ("date_created", "date_modified", "ein", "id", "is_alias_of_id", "name", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id") VALUES (NEW."date_created", NEW."date_modified", NEW."ein", NEW."id", NEW."is_alias_of_id", NEW."name", _pgh_attach_context(), NOW(), 'snapshot', NEW."id"); RETURN NULL;
                END;
            $$ LANGUAGE plpgsql;

            DROP TRIGGER IF EXISTS pgtrigger_snapshot_insert_79a6c ON "people_db_school";
            CREATE  TRIGGER pgtrigger_snapshot_insert_79a6c
                AFTER INSERT ON "people_db_school"
            ...
            RETURNS TRIGGER AS $$
                ...
                BEGIN
                    IF ("public"._pgtrigger_should_ignore(TG_NAME) IS TRUE) THEN
                        ...
                        END IF;
                    END IF;
                    INSERT INTO "people_db_sourceevent" ("date_accessed", "date_created", "date_modified", "id", "notes", "person_id", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "url") VALUES (NEW."date_accessed", NEW."date_created", NEW."date_modified", NEW."id", NEW."notes", NEW."person_id", _pgh_attach_context(), NOW(), 'snapshot', NEW."id", NEW."url"); RETURN NULL;
                END;
            $$ LANGUAGE plpgsql;

            DROP TRIGGER IF EXISTS pgtrigger_snapshot_insert_c86e5 ON "people_db_source";
            CREATE  TRIGGER pgtrigger_snapshot_insert_c86e5
                AFTER INSERT ON "people_db_source"
...
--
ALTER TABLE "people_db_sourceevent" ADD COLUMN "person_id" integer NULL;
--
-- Add field pgh_context to sourceevent
--
ALTER TABLE "people_db_sourceevent" ADD COLUMN "pgh_context_id" uuid NULL;
--
-- Add field pgh_obj to sourceevent
--
ALTER TABLE "people_db_sourceevent" ADD COLUMN "pgh_obj_id" integer NOT NULL;
--
-- Add field is_alias_of to schoolevent
--
ALTER TABLE "people_db_schoolevent" ADD COLUMN "is_alias_of_id" integer NULL;
--
-- Add field pgh_context to schoolevent
--
ALTER TABLE "people_db_schoolevent" ADD COLUMN "pgh_context_id" uuid NULL;
--
-- Add field pgh_obj to schoolevent
--
ALTER TABLE "people_db_schoolevent" ADD COLUMN "pgh_obj_id" integer NOT NULL;
--
-- Add field pgh_context to retentioneventevent
--
ALTER TABLE "people_db_retentioneventevent" ADD COLUMN "pgh_context_id" uuid NULL;
--
-- Add field pgh_obj to retentioneventevent
--
ALTER TABLE "people_db_retentioneventevent" ADD COLUMN "pgh_obj_id" integer NOT NULL;
--
-- Add field position to retentioneventevent
--
ALTER TABLE "people_db_retentioneventevent" ADD COLUMN "position_id" integer NULL;
--
-- Add field pgh_context to raceevent
--
ALTER TABLE "people_db_raceevent" ADD COLUMN "pgh_context_id" uuid NULL;
--
-- Add field pgh_obj to raceevent
--
ALTER TABLE "people_db_raceevent" ADD COLUMN "pgh_obj_id" integer NOT NULL;
--
-- Add field appointer to positionevent
--
ALTER TABLE "people_db_positionevent" ADD COLUMN "appointer_id" integer NULL;
--
-- Add field court to positionevent
--
ALTER TABLE "people_db_positionevent" ADD COLUMN "court_id" varchar(15) NULL;
--
-- Add field person to positionevent
--
ALTER TABLE "people_db_positionevent" ADD COLUMN "person_id" integer NULL;
--
-- Add field pgh_context to positionevent
--
ALTER TABLE "people_db_positionevent" ADD COLUMN "pgh_context_id" uuid NULL;
--
-- Add field pgh_obj to positionevent
--
ALTER TABLE "people_db_positionevent" ADD COLUMN "pgh_obj_id" integer NOT NULL;
--
-- Add field predecessor to positionevent
--
ALTER TABLE "people_db_positionevent" ADD COLUMN "predecessor_id" integer NULL;
--
-- Add field school to positionevent
--
ALTER TABLE "people_db_positionevent" ADD COLUMN "school_id" integer NULL;
--
-- Add field supervisor to positionevent
--
ALTER TABLE "people_db_positionevent" ADD COLUMN "supervisor_id" integer NULL;
--
-- Add field person to politicalaffiliationevent
--
ALTER TABLE "people_db_politicalaffiliationevent" ADD COLUMN "person_id" integer NULL;
--
-- Add field pgh_context to politicalaffiliationevent
--
ALTER TABLE "people_db_politicalaffiliationevent" ADD COLUMN "pgh_context_id" uuid NULL;
--
-- Add field pgh_obj to politicalaffiliationevent
--
ALTER TABLE "people_db_politicalaffiliationevent" ADD COLUMN "pgh_obj_id" integer NOT NULL;
--
-- Add field person to personraceevent
--
ALTER TABLE "people_db_personraceevent" ADD COLUMN "person_id" integer NOT NULL;
--
-- Add field pgh_context to personraceevent
--
ALTER TABLE "people_db_personraceevent" ADD COLUMN "pgh_context_id" uuid NULL;
--
-- Add field race to personraceevent
--
ALTER TABLE "people_db_personraceevent" ADD COLUMN "race_id" integer NOT NULL;
--
-- Add field is_alias_of to personevent
--
ALTER TABLE "people_db_personevent" ADD COLUMN "is_alias_of_id" integer NULL;
--
-- Add field pgh_context to personevent
--
ALTER TABLE "people_db_personevent" ADD COLUMN "pgh_context_id" uuid NULL;
--
-- Add field pgh_obj to personevent
--
ALTER TABLE "people_db_personevent" ADD COLUMN "pgh_obj_id" integer NOT NULL;
--
-- Add field docket to partiesevent
--
ALTER TABLE "people_db_partiesevent" ADD COLUMN "docket_id" integer NOT NULL;
--
-- Add field party to partiesevent
--
ALTER TABLE "people_db_partiesevent" ADD COLUMN "party_id" integer NOT NULL;
--
-- Add field pgh_context to partiesevent
--
ALTER TABLE "people_db_partiesevent" ADD COLUMN "pgh_context_id" uuid NULL;
--
-- Add field person to educationevent
--
ALTER TABLE "people_db_educationevent" ADD COLUMN "person_id" integer NULL;
--
-- Add field pgh_context to educationevent
--
ALTER TABLE "people_db_educationevent" ADD COLUMN "pgh_context_id" uuid NULL;
--
-- Add field pgh_obj to educationevent
--
ALTER TABLE "people_db_educationevent" ADD COLUMN "pgh_obj_id" integer NOT NULL;
--
-- Add field school to educationevent
--
ALTER TABLE "people_db_educationevent" ADD COLUMN "school_id" integer NOT NULL;
--
...
--
            ...
            RETURNS TRIGGER AS $$
                ...
                BEGIN
                    IF ("public"._pgtrigger_should_ignore(TG_NAME) IS TRUE) THEN
                        ...
                        END IF;
                    END IF;
                    INSERT INTO "people_db_partiesevent" ("date_terminated", "docket_id", "extra_info", "highest_offense_level_opening", "highest_offense_level_terminated", "id", "name", "party_id", "pgh_context_id", "pgh_created_at", "pgh_label") VALUES (NEW."date_terminated", NEW."docket_id", NEW."extra_info", NEW."highest_offense_level_opening", NEW."highest_offense_level_terminated", NEW."id", NEW."name", NEW."party_id", _pgh_attach_context(), NOW(), 'snapshot'); RETURN NULL;
                END;
            $$ LANGUAGE plpgsql;
            ...
            CREATE  TRIGGER pgtrigger_snapshot_insert_f73de
                AFTER INSERT ON "people_db_partytype"
...
--
            ...
            CREATE  TRIGGER pgtrigger_snapshot_update_a07b5
                AFTER UPDATE ON "people_db_partytype"
...
--
            ...
            RETURNS TRIGGER AS $$
                ...
                BEGIN
                    IF ("public"._pgtrigger_should_ignore(TG_NAME) IS TRUE) THEN
                        ...
                        END IF;
                    END IF;
                    INSERT INTO "people_db_personraceevent" ("id", "person_id", "pgh_context_id", "pgh_created_at", "pgh_label", "race_id") VALUES (NEW."id", NEW."person_id", _pgh_attach_context(), NOW(), 'snapshot', NEW."race_id"); RETURN NULL;
                END;
            $$ LANGUAGE plpgsql;
            ...
            CREATE  TRIGGER pgtrigger_snapshot_insert_3bcce
                AFTER INSERT ON "people_db_person_race"
...
--
            ...
            CREATE  TRIGGER pgtrigger_snapshot_update_134c2
                AFTER UPDATE ON "people_db_person_race"
