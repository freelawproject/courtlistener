    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filepath', models.FileField(help_text='The disclosure report itself', upload_to='financial-disclosures/', db_index=True)),
                ('thumbnail', models.FileField(help_text='A thumbnail of the first page of the disclosure form', null=True, upload_to='financial-disclosures/thumbnails/', blank=True)),
