# Generated by Django 3.2.18 on 2023-03-16 23:10
    ...
    operations = [
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(name='custom_snapshot_update',
                                               sql=pgtrigger.compiler.UpsertTriggerSql(
                                                   condition='WHEN (OLD."id" IS DISTINCT FROM NEW."id" OR OLD."date_created" IS DISTINCT FROM NEW."date_created" OR OLD."person_id" IS DISTINCT FROM NEW."person_id" OR OLD."year_rated" IS DISTINCT FROM NEW."year_rated" OR OLD."rating" IS DISTINCT FROM NEW."rating")',
                                                   func='INSERT INTO "people_db_abaratingevent" ("date_created", "date_modified", "id", "person_id", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "rating", "year_rated") VALUES (OLD."date_created", OLD."date_modified", OLD."id", OLD."person_id", _pgh_attach_context(), NOW(), \'custom_snapshot\', OLD."id", OLD."rating", OLD."year_rated"); RETURN NULL;',
                                                   hash='b4fc29cbc947feeddca467bad9dc2b682fa0b7a3',
                                                   operation='UPDATE',
                                                   pgid='pgtrigger_custom_snapshot_update_22ecc',
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(name='custom_snapshot_update',
                                               sql=pgtrigger.compiler.UpsertTriggerSql(
                                                   ...
                                                   func='INSERT INTO "people_db_personraceevent" ("id", "person_id", "pgh_context_id", "pgh_created_at", "pgh_label", "race_id") VALUES (OLD."id", OLD."person_id", _pgh_attach_context(), NOW(), \'custom_snapshot\', OLD."race_id"); RETURN NULL;',
                                                   hash='dc6d7cff394c39f23ab5748732192205b205435a',
                                                   operation='UPDATE',
                                                   pgid='pgtrigger_custom_snapshot_update_f23b1',
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(name='custom_snapshot_update',
                                               sql=pgtrigger.compiler.UpsertTriggerSql(
                                                   ...
                                                   hash='c72f8742889abc1975ff8c43771dc26a232dc72f',
                                                   operation='UPDATE',
                                                   pgid='pgtrigger_custom_snapshot_update_3a9c5',
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(name='custom_snapshot_update',
                                               sql=pgtrigger.compiler.UpsertTriggerSql(
                                                   condition='WHEN (OLD.* IS DISTINCT FROM NEW.*)',
                                                   func='INSERT INTO "people_db_raceevent" ("id", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "race") VALUES (OLD."id", _pgh_attach_context(), NOW(), \'custom_snapshot\', OLD."id", OLD."race"); RETURN NULL;',
                                                   hash='3bfda2f7fdcb02cae529637b6bedd8e18b4eca71',
                                                   operation='UPDATE',
                                                   pgid='pgtrigger_custom_snapshot_update_d01a8',
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(name='custom_snapshot_update',
                                               sql=pgtrigger.compiler.UpsertTriggerSql(
                                                   condition='WHEN (OLD."id" IS DISTINCT FROM NEW."id" OR OLD."date_created" IS DISTINCT FROM NEW."date_created" OR OLD."position_id" IS DISTINCT FROM NEW."position_id" OR OLD."retention_type" IS DISTINCT FROM NEW."retention_type" OR OLD."date_retention" IS DISTINCT FROM NEW."date_retention" OR OLD."votes_yes" IS DISTINCT FROM NEW."votes_yes" OR OLD."votes_no" IS DISTINCT FROM NEW."votes_no" OR OLD."votes_yes_percent" IS DISTINCT FROM NEW."votes_yes_percent" OR OLD."votes_no_percent" IS DISTINCT FROM NEW."votes_no_percent" OR OLD."unopposed" IS DISTINCT FROM NEW."unopposed" OR OLD."won" IS DISTINCT FROM NEW."won")',
                                                   ...
                                                   hash='66300dde3dd193bffe5c78bf07180caebbd52986',
                                                   operation='UPDATE',
                                                   pgid='pgtrigger_custom_snapshot_update_03dc7',
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(name='custom_snapshot_update',
                                               sql=pgtrigger.compiler.UpsertTriggerSql(
                                                   condition='WHEN (OLD."id" IS DISTINCT FROM NEW."id" OR OLD."date_created" IS DISTINCT FROM NEW."date_created" OR OLD."is_alias_of_id" IS DISTINCT FROM NEW."is_alias_of_id" OR OLD."name" IS DISTINCT FROM NEW."name" OR OLD."ein" IS DISTINCT FROM NEW."ein")',
                                                   func='INSERT INTO "people_db_schoolevent" ("date_created", "date_modified", "ein", "id", "is_alias_of_id", "name", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id") VALUES (OLD."date_created", OLD."date_modified", OLD."ein", OLD."id", OLD."is_alias_of_id", OLD."name", _pgh_attach_context(), NOW(), \'custom_snapshot\', OLD."id"); RETURN NULL;',
                                                   hash='489b158007ead1eedbbe7c4deba2d56da980c8f5',
                                                   operation='UPDATE',
                                                   pgid='pgtrigger_custom_snapshot_update_e952c',
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(name='custom_snapshot_update',
                                               sql=pgtrigger.compiler.UpsertTriggerSql(
                                                   condition='WHEN (OLD."id" IS DISTINCT FROM NEW."id" OR OLD."date_created" IS DISTINCT FROM NEW."date_created" OR OLD."person_id" IS DISTINCT FROM NEW."person_id" OR OLD."url" IS DISTINCT FROM NEW."url" OR OLD."date_accessed" IS DISTINCT FROM NEW."date_accessed" OR OLD."notes" IS DISTINCT FROM NEW."notes")',
                                                   func='INSERT INTO "people_db_sourceevent" ("date_accessed", "date_created", "date_modified", "id", "notes", "person_id", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "url") VALUES (OLD."date_accessed", OLD."date_created", OLD."date_modified", OLD."id", OLD."notes", OLD."person_id", _pgh_attach_context(), NOW(), \'custom_snapshot\', OLD."id", OLD."url"); RETURN NULL;',
                                                   hash='f960b74ed8392d78c487dca100b47c1c060006db',
                                                   operation='UPDATE',
                                                   pgid='pgtrigger_custom_snapshot_update_f797d',
