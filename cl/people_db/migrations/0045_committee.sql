...
--
CREATE TABLE "people_db_committee" ("id" serial NOT NULL PRIMARY KEY, "committee_uniq_id" varchar(9) NOT NULL, "committee_name" varchar(200) NOT NULL, "committee_party" varchar(3) NOT NULL, "candidate_id" varchar(9) NOT NULL, "connected_org_name" varchar(200) NOT NULL);
