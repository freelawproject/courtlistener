# Generated by Django 3.2.16 on 2023-01-25 20:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pgh_label', models.TextField(help_text='The event label.')),
                ('id', models.IntegerField()),
                ('name', models.CharField(help_text='The name of the type (Defendant, Plaintiff, etc.)', max_length=100)),
                ...
                ('extra_info', models.TextField(blank=True, help_text='Additional info from PACER')),
        ...
        migrations.AddField(
            model_name='partiesevent',
            name='party',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='people_db.party'),
        ),
        migrations.AddField(
            model_name='partiesevent',
            name='pgh_context',
        ...
        pgtrigger.migrations.AddTrigger(
            model_name='parties',
            trigger=pgtrigger.compiler.Trigger(name='snapshot_insert', sql=pgtrigger.compiler.UpsertTriggerSql(func='INSERT INTO "people_db_partiesevent" ("date_terminated", "docket_id", "extra_info", "highest_offense_level_opening", "highest_offense_level_terminated", "id", "name", "party_id", "pgh_context_id", "pgh_created_at", "pgh_label") VALUES (NEW."date_terminated", NEW."docket_id", NEW."extra_info", NEW."highest_offense_level_opening", NEW."highest_offense_level_terminated", NEW."id", NEW."name", NEW."party_id", _pgh_attach_context(), NOW(), \'snapshot\'); RETURN NULL;', hash='17eb7f8b615107e6c29b2cbb50101f680fb23557', operation='INSERT', pgid='pgtrigger_snapshot_insert_f73de', table='people_db_partytype', when='AFTER')),
        ),
        pgtrigger.migrations.AddTrigger(
            model_name='parties',
            trigger=pgtrigger.compiler.Trigger(name='snapshot_update', sql=pgtrigger.compiler.UpsertTriggerSql(condition='WHEN (OLD.* IS DISTINCT FROM NEW.*)', func='INSERT INTO "people_db_partiesevent" ("date_terminated", "docket_id", "extra_info", "highest_offense_level_opening", "highest_offense_level_terminated", "id", "name", "party_id", "pgh_context_id", "pgh_created_at", "pgh_label") VALUES (NEW."date_terminated", NEW."docket_id", NEW."extra_info", NEW."highest_offense_level_opening", NEW."highest_offense_level_terminated", NEW."id", NEW."name", NEW."party_id", _pgh_attach_context(), NOW(), \'snapshot\'); RETURN NULL;', hash='62f6fd044b826bfcaecb962ade08a728c9a27af3', operation='UPDATE', pgid='pgtrigger_snapshot_update_a07b5', table='people_db_partytype', when='AFTER')),
        ),
        pgtrigger.migrations.AddTrigger(
