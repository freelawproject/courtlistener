# Generated by Django 3.2.18 on 2023-03-16 22:55
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(name='custom_snapshot_update',
                                               sql=pgtrigger.compiler.UpsertTriggerSql(
                                                   ...
                                                   func='INSERT INTO "audio_audiopanelevent" ("audio_id", "id", "person_id", "pgh_context_id", "pgh_created_at", "pgh_label") VALUES (OLD."audio_id", OLD."id", OLD."person_id", _pgh_attach_context(), NOW(), \'custom_snapshot\'); RETURN NULL;',
                                                   hash='085b4ec0423661deb14f614162b05e76db4fa3da',
                                                   operation='UPDATE',
                                                   pgid='pgtrigger_custom_snapshot_update_2497c',
