    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('local_path_mp3', models.FileField(help_text='The location, relative to MEDIA_ROOT, on the CourtListener server, where encoded file is stored', upload_to=cl.lib.model_helpers.make_upload_path, db_index=True, blank=True)),
                ('local_path_original_file', models.FileField(help_text='The location, relative to MEDIA_ROOT, on the CourtListener server, where the original file is stored', upload_to=cl.lib.model_helpers.make_upload_path, db_index=True)),
