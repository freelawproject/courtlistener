...
class Command(BaseCommand):
    ...
    def follow_redirections(self, r, s):
        """
        ...
        if redirected:
            ...
            r = self.follow_redirections(s.get(url), s)
        return r

    def get_extension(self, content):
        ...
        if not abort:
            for i in range(0, len(site.case_names)):
                try:
                    ...
                    r = self.follow_redirections(r, s)
                except:
                ...
                if onwards:
                    ...
                    try:
                        ...
                        extension = self.get_extension(r.content)
