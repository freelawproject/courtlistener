...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'urlToHash.url'
        db.alter_column('urlToHash', 'url', self.gf('django.db.models.fields.CharField')(max_length=5000))
    def backwards(self, orm):

        # Changing field 'urlToHash.url'
        db.alter_column('urlToHash', 'url', self.gf('django.db.models.fields.CharField')(max_length=300))
    models = {
        'scrapers.errorlog': {
