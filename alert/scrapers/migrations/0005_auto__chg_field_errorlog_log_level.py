...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ErrorLog.log_level'
        db.alter_column('scrapers_errorlog', 'log_level', self.gf('django.db.models.fields.CharField')(max_length=15))
    def backwards(self, orm):

        # Changing field 'ErrorLog.log_level'
        db.alter_column('scrapers_errorlog', 'log_level', self.gf('django.db.models.fields.CharField')(max_length=6))
    models = {
        'scrapers.errorlog': {
