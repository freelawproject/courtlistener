...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Favorite.doc_id'
        db.add_column('Favorite', 'doc_id', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'Favorite.doc_id'
        db.delete_column('Favorite', 'doc_id')
