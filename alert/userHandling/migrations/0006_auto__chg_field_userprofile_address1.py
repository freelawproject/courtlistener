...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.address1'
        db.alter_column('UserProfile', 'address1', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'UserProfile.address1'
        raise RuntimeError("Cannot reverse this migration. 'UserProfile.address1' and its values cannot be restored.")
    models = {
        'alerts.alert': {
