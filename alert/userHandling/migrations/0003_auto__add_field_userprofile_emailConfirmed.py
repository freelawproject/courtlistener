...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.emailConfirmed'
        db.add_column('UserProfile', 'emailConfirmed', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.emailConfirmed'
        db.delete_column('UserProfile', 'emailConfirmed')
