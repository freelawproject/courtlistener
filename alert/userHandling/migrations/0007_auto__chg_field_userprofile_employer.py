...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.employer'
        db.alter_column('UserProfile', 'employer', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    def backwards(self, orm):

        # Changing field 'UserProfile.employer'
        db.alter_column('UserProfile', 'employer', self.gf('django.db.models.fields.CharField')(default='', max_length=100))
    models = {
        'alerts.alert': {
