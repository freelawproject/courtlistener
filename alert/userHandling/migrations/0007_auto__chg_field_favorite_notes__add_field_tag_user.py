...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Favorite.notes'
        db.alter_column('Favorite', 'notes', self.gf('django.db.models.fields.TextField')(max_length=1000))

        # Adding field 'Tag.user'
        db.add_column('Tag', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)

    def backwards(self, orm):
        
        # Changing field 'Favorite.notes'
        db.alter_column('Favorite', 'notes', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Deleting field 'Tag.user'
        db.delete_column('Tag', 'user_id')
    ...
    models = {
        ...
        'userHandling.favorite': {
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'favorites'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['userHandling.Tag']"})
        },
        'userHandling.tag': {
