...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Favorite.doc_id' to match new field type.
        db.rename_column('Favorite', 'doc_id', 'doc_id_id')
        # Changing field 'Favorite.doc_id'
        db.alter_column('Favorite', 'doc_id_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alertSystem.Document']))

        # Adding index on 'Favorite', fields ['doc_id']
        db.create_index('Favorite', ['doc_id_id'])

    def backwards(self, orm):
        
        # Removing index on 'Favorite', fields ['doc_id']
        db.delete_index('Favorite', ['doc_id_id'])

        # Renaming column for 'Favorite.doc_id' to match new field type.
        db.rename_column('Favorite', 'doc_id_id', 'doc_id')
        # Changing field 'Favorite.doc_id'
        db.alter_column('Favorite', 'doc_id', self.gf('django.db.models.fields.IntegerField')())
