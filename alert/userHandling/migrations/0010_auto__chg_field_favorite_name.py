...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Favorite.name'
        db.alter_column('Favorite', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))


    def backwards(self, orm):
        
        # Changing field 'Favorite.name'
        db.alter_column('Favorite', 'name', self.gf('django.db.models.fields.TextField')(max_length=200))
