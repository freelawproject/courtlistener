...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('Favorite', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)

        # Changing field 'Favorite.notes'
        db.alter_column('Favorite', 'notes', self.gf('django.db.models.fields.TextField')(max_length=500))
