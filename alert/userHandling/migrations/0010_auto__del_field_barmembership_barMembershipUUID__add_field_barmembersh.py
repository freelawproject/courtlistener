...
class Migration(SchemaMigration):
    def forwards(self, orm):
        db.rename_column('BarMembership', 'barMembershipUUID', 'id')
        db.rename_column('UserProfile', 'userProfileUUID', 'id')

    def backwards(self, orm):
        db.rename_column('BarMembership', 'id', 'barMembershipUUID')
        db.rename_column('UserProfile', 'id', 'userProfileUUID')
    ...
    models = {
        ...
        u'userHandling.barmembership': {
            ...
            'barMembership': ('localflavor.us.models.USStateField', [], {'max_length': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
