...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('UserProfile', 'activationKey', self.gf('django.db.models.fields.CharField')(default='', max_length=40), keep_default=False)

        # Adding field 'UserProfile.key_expires'
        db.add_column('UserProfile', 'key_expires', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.activationKey'
        db.delete_column('UserProfile', 'activationKey')

        # Deleting field 'UserProfile.key_expires'
        db.delete_column('UserProfile', 'key_expires')
