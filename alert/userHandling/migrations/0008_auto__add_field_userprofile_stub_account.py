...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.stub_account'
        db.add_column('UserProfile', 'stub_account',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'UserProfile.stub_account'
        db.delete_column('UserProfile', 'stub_account')
