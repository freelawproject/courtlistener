...
var KEY = {
    ...
    NUMPAD_ENTER: 108,
    COMMA: 188,
    // Added by mlissner - online keycode lists are wrong about these.
    // They must be measured to be determined. Not sure why.
    LPAREN: 57,
    RPAREN: 48,
    PLUS: 61,
    PIPE: 220
    ...
    var input_box = $("<input type=\"text\"  autocomplete=\"off\">")
        ...
        .keydown(function (event) {
            ...
            switch(event.keyCode) {
                ...
                case KEY.LPAREN:
                case KEY.RPAREN:
                    // Added by mlissner. Blocks these keys from being entered.
                    return false;
                    break;*/
