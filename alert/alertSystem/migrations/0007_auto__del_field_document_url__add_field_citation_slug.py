...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Citation.slug'
        db.add_column('Citation', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Citation.slug'
        db.delete_column('Citation', 'slug')
