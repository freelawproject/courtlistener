...
from alertSystem.string_utils import trunc

class Migration(DataMigration):
    """Adds and prepopulates the slug field"""
    def forwards(self, orm):
        for cite in orm.Citation.objects.all():
            cite.slug = slugify(trunc(cite.caseNameShort, 50))
            cite.save()
