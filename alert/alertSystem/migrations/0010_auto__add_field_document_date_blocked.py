...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Document.date_blocked'
        db.add_column('Document', 'date_blocked', self.gf('django.db.models.fields.DateField')(null = True, blank = True), keep_default = False)


    def backwards(self, orm):

        # Deleting field 'Document.date_blocked'
        db.delete_column('Document', 'date_blocked')
