...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Citation.docketNumber'
        db.alter_column('Citation', 'docketNumber', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True))

        # Changing field 'Citation.lexisCite'
        db.alter_column('Citation', 'lexisCite', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True))

        # Changing field 'Citation.westCite'
        db.alter_column('Citation', 'westCite', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True))


    def backwards(self, orm):

        # Changing field 'Citation.docketNumber'
        db.alter_column('Citation', 'docketNumber', self.gf('django.db.models.fields.CharField')(blank=True, max_length=50))

        # Changing field 'Citation.lexisCite'
        db.alter_column('Citation', 'lexisCite', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True))

        # Changing field 'Citation.westCite'
        db.alter_column('Citation', 'westCite', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True))
