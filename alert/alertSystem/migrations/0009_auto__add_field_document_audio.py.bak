...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Document.audio'
        db.add_column('Document', 'audio', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['audio.Audio'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Document.audio'
        db.delete_column('Document', 'audio_id')
    ...
    models = {
        ...
        'alertSystem.document': {
            ...
            'audio': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['audio.Audio']", 'null': 'True', 'blank': 'True'}),
        ...
        'audio.audio': {
            'Meta': {'ordering': "['-time_retrieved']", 'object_name': 'Audio', 'db_table': "'Audio'"},
            'SHA1': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'argued': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'download_URL': ('django.db.models.fields.URLField', [], {'max_length': '200'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'length': ('django.db.models.fields.TimeField', [], {}),
            'local_path_mp3': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'blank': 'True'}),
            'local_path_ogg': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'blank': 'True'}),
            'sample_rate_mp3': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'time_retrieved': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'})
        }
    }
