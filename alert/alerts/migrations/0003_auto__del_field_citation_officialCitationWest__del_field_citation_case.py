...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'Citation.officialCitationWest'
        db.rename_column('Citation', 'officialCitationWest', 'westCite')

        # Renaming field 'Citation.caseNumber'
        db.rename_column('Citation', 'caseNumber', 'docketNumber')

        # Renaming field 'Citation.officialCitationLexis'
        db.rename_column('Citation', 'officialCitationLexis', 'lexisCite')


    def backwards(self, orm):
        # Renaming field 'Citation.officialCitationWest'
        db.rename_column('Citation', 'westCite', 'officialCitationWest')

        # Renaming field 'Citation.caseNumber'
        db.rename_column('Citation', 'docketNumber', 'caseNumber')

        # Renaming field 'Citation.officialCitationLexis'
        db.rename_column('Citation', 'lexisCite', 'officialCitationLexis')
    ...
    models = {
        'alertSystem.citation': {
            ...
            'docketNumber': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '50', 'blank': 'True'}),
            'lexisCite': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'null': 'True'}),
            'westCite': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'})
        },
        'alertSystem.court': {
