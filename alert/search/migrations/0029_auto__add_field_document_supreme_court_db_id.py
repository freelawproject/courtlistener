...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.supreme_court_db_id'
        db.add_column('Document', 'supreme_court_db_id',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.supreme_court_db_id'
        db.delete_column('Document', 'supreme_court_db_id')
