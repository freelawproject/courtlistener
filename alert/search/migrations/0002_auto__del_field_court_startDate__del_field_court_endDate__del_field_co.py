...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'Court.startDate'
        db.rename_column('Court', 'startDate', 'start_date')

        # Renaming field 'Court.endDate'
        db.rename_column('Court', 'endDate', 'end_date')

        # Renaming field 'Court.shortName'
        db.rename_column('Court', 'shortName', 'citation_string')

        # Adding field 'Court.short_name'
        db.add_column('Court', 'short_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'Court.full_name'
        db.add_column('Court', 'full_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length='200'),
                      keep_default=False)

        # Changing field 'Court.courtUUID'
        db.alter_column('Court', 'courtUUID', self.gf('django.db.models.fields.CharField')(max_length=6, primary_key=True))

    def backwards(self, orm):
        # Renaming field 'Court.startDate'
        db.rename_column('Court', 'start_date', 'startDate')

        # Renaming field 'Court.endDate'
        db._column('Court', 'end_date', 'endDate')

        # Renaming field 'Court.shortName'
        db.rename_column('Court', 'citation_string', 'shortName')

        # Deleting field 'Court.short_name'
        db.delete_column('Court', 'short_name')

        # Deleting field 'Court.full_name'
        db.delete_column('Court', 'full_name')

        # Changing field 'Court.courtUUID'
        db.alter_column('Court', 'courtUUID', self.gf('django.db.models.fields.CharField')(max_length=100, primary_key=True))
