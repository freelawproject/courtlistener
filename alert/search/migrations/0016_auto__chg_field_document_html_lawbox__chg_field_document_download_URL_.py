...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Document.html_lawbox'
        db.alter_column('Document', 'html_lawbox', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Document.html_lawbox'
        db.alter_column('Document', 'html_lawbox', self.gf('django.db.models.fields.TextField')(default=''))
