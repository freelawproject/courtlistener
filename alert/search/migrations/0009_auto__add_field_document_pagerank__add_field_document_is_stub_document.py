...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.pagerank'
        db.add_column('Document', 'pagerank',
                      self.gf('django.db.models.fields.FloatField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Document.is_stub_document'
        db.add_column('Document', 'is_stub_document',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.pagerank'
        db.delete_column('Document', 'pagerank')

        # Deleting field 'Document.is_stub_document'
        db.delete_column('Document', 'is_stub_document')
