...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('Citation', 'docket_number', self.gf('django.db.models.fields.CharField')(max_length=5000, null=True))

        # Changing field 'Document.html'
        db.alter_column('Document', 'html', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Document.html'
        db.alter_column('Document', 'html', self.gf('django.db.models.fields.TextField')(default=''))
