...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Document', fields ['local_path']
        db.create_index('Document', ['local_path'])

    def backwards(self, orm):
        # Removing index on 'Document', fields ['local_path']
        db.delete_index('Document', ['local_path'])
