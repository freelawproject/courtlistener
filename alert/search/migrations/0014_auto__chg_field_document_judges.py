...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Document.judges'
        db.alter_column('Document', 'judges', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Document.judges'
        db.alter_column('Document', 'judges', self.gf('django.db.models.fields.TextField')(default=''))
