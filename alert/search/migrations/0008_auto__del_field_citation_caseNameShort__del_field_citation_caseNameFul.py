...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Deleting field 'Citation.caseNameShort'
        db.delete_column('Citation', 'caseNameShort')

        # Renaming field caseNameFull as case_name
        db.rename_column('Citation', 'caseNameFull', 'case_name')

    def backwards(self, orm):
        # Adding field 'Citation.caseNameShort'
        db.add_column('Citation', 'caseNameShort',
                      self.gf('django.db.models.fields.CharField')(blank=True, default='', max_length=100, db_index=True),
                      keep_default=False)

        # Renaming field case_name back to caseNameFull
        db.rename_column('Citation', 'case_name', 'caseNameFull')
