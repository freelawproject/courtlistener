...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('Document', 'download_URL', self.gf('django.db.models.fields.URLField')(max_length=500, null=True))

    def backwards(self, orm):

        # Changing field 'Document.download_URL'
        db.alter_column('Document', 'download_URL', self.gf('django.db.models.fields.URLField')(default='', max_length=500))
