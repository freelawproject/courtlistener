...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('Citation', 'docketNumber', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    def backwards(self, orm):

        # Changing field 'Citation.docketNumber'
        db.alter_column('Citation', 'docketNumber', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    models = {
        'search.citation': {
            ...
            'docketNumber': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
