...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.judges'
        db.add_column('Document', 'judges',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Document.nature_of_suit'
        db.add_column('Document', 'nature_of_suit',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Document.judges'
        db.delete_column('Document', 'judges')

        # Deleting field 'Document.nature_of_suit'
        db.delete_column('Document', 'nature_of_suit')
