...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Court.has_scraper'
        db.add_column('Court', 'has_scraper',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Court.has_scraper'
        db.delete_column('Court', 'has_scraper')
    ...
    models = {
        ...
        u'search.court': {
            ...
            'has_scraper': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
