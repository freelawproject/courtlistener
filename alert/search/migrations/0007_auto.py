...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Document', fields ['time_retrieved']
        db.create_index('Document', ['time_retrieved'])

    def backwards(self, orm):
        # Removing index on 'Document', fields ['time_retrieved']
        db.delete_index('Document', ['time_retrieved'])
