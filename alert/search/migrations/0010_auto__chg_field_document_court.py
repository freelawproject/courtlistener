...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Document.court'
        db.alter_column('Document', 'court_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['search.Court'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Document.court'
        raise RuntimeError("Cannot reverse this migration. 'Document.court' and its values cannot be restored.")
