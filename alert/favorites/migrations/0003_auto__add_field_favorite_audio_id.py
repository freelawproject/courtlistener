...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Favorite.audio_id'
        db.add_column('Favorite', 'audio_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['audio.Audio'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Favorite.audio_id'
        db.delete_column('Favorite', 'audio_id_id')
